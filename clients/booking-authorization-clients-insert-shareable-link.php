...
//============DUPLICATE THE INFORMATION TO A NEW LINE IN THE DATABASE=============================

$CGroupName=$_POST['GroupName'];
$AgentUniqID=$_POST['AgentUniqID'];
...
$sql1 = "INSERT INTO booking_1 (BookUnique, AgentID, AgentUniqID, BusinessName, BusinessFullName, BusinessPhone, BusinessEmail, EmaiToFullName, EmaiToEmail, EmaiToSubject, EmailToType, GroupName, UGroupName, ServiceAgreementType, ServiceCurrency, QuoteNumberPersons, QuoteFeePerPerson, QuoteTotalFee, ServiceDetails, ServicePDF, Supplier, BookingNumber, CheckSupplier, TripDetails, TripDetailsPDF, TripPricingCurrency, TripPaymentSchedule, NumberOfPersons1, PricePerPerson1, TotalPrice1, PricingDescription1, NumberOfPersons2, PricePerPerson2, TotalPrice2, PricingDescription2, NumberOfPersons3, PricePerPerson3, TotalPrice3, PricingDescription3, NumberOfPersons4, PricePerPerson4, TotalPrice4, PricingDescription4, NumberOfPersons5, PricePerPerson5, TotalPrice5, PricingDescription5, FullPayment, FullPaymentDate, TotalAmountDue, PaymentType1, PaymentDate1, PaymentDue1, PaymentType2, PaymentDate2, PaymentDue2, PaymentType3, PaymentDate3, PaymentDue3, PaymentType4, PaymentDate4, PaymentDue4, PaymentType5, PaymentDate5, PaymentDue5, PricingType1, PricingType2, PricingType3, PricingType4, PricingType5, TermsType, TermsAndConditions, TermsAndConditionsPDF, CancellationPolicy, CancellationPolicyPDF, InsuranceProvider, InsuranceCurrency, InsurancePDF, InsurancePersonType1, InsuranceNumberPersons1, InsurancePricePerPerson1, InsuranceTotalPrice1, InsuranceDescription1, InsurancePersonType2, InsuranceNumberPersons2, InsurancePricePerPerson2, InsuranceTotalPrice2, InsuranceDescription2, InsurancePersonType3, InsuranceNumberPersons3, InsurancePricePerPerson3, InsuranceTotalPrice3, InsuranceDescription3, InsurancePersonType4, InsuranceNumberPersons4, InsurancePricePerPerson4, InsuranceTotalPrice4, InsuranceDescription4, InsurancePersonType5, InsuranceNumberPersons5, InsurancePricePerPerson5, InsuranceTotalPrice5, InsuranceDescription5, AdditionalTitle1, AdditionalURL1, AdditionalPDF1, AdditionalTitle2, AdditionalURL2, AdditionalPDF2, AdditionalTitle3, AdditionalURL3, AdditionalPDF3, BookingFeeNumberPersons, BookingFeePerPerson, BookingFeeTotal, PTravellerParty, PTravellerTitle, PTravellerFName, PTravellerMName, PTravellerLName, PTravellerDOB, PTravellerPhone, PTravellerEmail, PTravellerStreet, PTravellerUnit, PTravellerCity, PTravellerProvince, PTravellerPostal, PTravellerCountry, PTravellerNotes, pricing1, pricing2, pricing3, pricing4, pricing5, insurance1, insurance2, insurance3, insurance4, insurance5, RequestPrimaryTravellerCC, RequestTravellersPassport)
SELECT '".$BookUnique."', AgentID, AgentUniqID, BusinessName, BusinessFullName, BusinessPhone, BusinessEmail, EmaiToFullName, EmaiToEmail, EmaiToSubject, EmailToType, GroupName, UGroupName, ServiceAgreementType, ServiceCurrency, '".$QuoteNumberPersons."', QuoteFeePerPerson, '".$QuoteTotalFee."', ServiceDetails, ServicePDF, Supplier, BookingNumber, CheckSupplier, TripDetails, TripDetailsPDF, TripPricingCurrency, TripPaymentSchedule, NumberOfPersons1, PricePerPerson1, TotalPrice1, PricingDescription1, NumberOfPersons2, PricePerPerson2, TotalPrice2, PricingDescription2, NumberOfPersons3, PricePerPerson3, TotalPrice3, PricingDescription3, NumberOfPersons4, PricePerPerson4, TotalPrice4, PricingDescription4, NumberOfPersons5, PricePerPerson5, TotalPrice5, PricingDescription5, FullPayment, FullPaymentDate, TotalAmountDue, PaymentType1, PaymentDate1, PaymentDue1, PaymentType2, PaymentDate2, PaymentDue2, PaymentType3, PaymentDate3, PaymentDue3, PaymentType4, PaymentDate4, PaymentDue4, PaymentType5, PaymentDate5, PaymentDue5, PricingType1, PricingType2, PricingType3, PricingType4, PricingType5, TermsType, TermsAndConditions, TermsAndConditionsPDF, CancellationPolicy, CancellationPolicyPDF, InsuranceProvider, InsuranceCurrency, InsurancePDF, InsurancePersonType1, InsuranceNumberPersons1, InsurancePricePerPerson1, InsuranceTotalPrice1, InsuranceDescription1, InsurancePersonType2, InsuranceNumberPersons2, InsurancePricePerPerson2, InsuranceTotalPrice2, InsuranceDescription2, InsurancePersonType3, InsuranceNumberPersons3, InsurancePricePerPerson3, InsuranceTotalPrice3, InsuranceDescription3, InsurancePersonType4, InsuranceNumberPersons4, InsurancePricePerPerson4, InsuranceTotalPrice4, InsuranceDescription4, InsurancePersonType5, InsuranceNumberPersons5, InsurancePricePerPerson5, InsuranceTotalPrice5, InsuranceDescription5, AdditionalTitle1, AdditionalURL1, AdditionalPDF1, AdditionalTitle2, AdditionalURL2, AdditionalPDF2, AdditionalTitle3, AdditionalURL3, AdditionalPDF3, '".$BookingFeeNumberPersons."', BookingFeePerPerson,
'".$BookingFeeTotal."', PTravellerParty, PTravellerTitle, PTravellerFName, PTravellerMName, PTravellerLName, PTravellerDOB, PTravellerPhone, PTravellerEmail, PTravellerStreet, PTravellerUnit, PTravellerCity, PTravellerProvince, PTravellerPostal, PTravellerCountry, PTravellerNotes, pricing1, pricing2, pricing3, pricing4, pricing5, insurance1, insurance2, insurance3, insurance4, insurance5, RequestPrimaryTravellerCC, RequestTravellersPassport FROM booking_1 WHERE BookID='$BookID'";
...
$sql2 = "INSERT INTO booking_2 (BookID2, BookUnique, AgentID, BookingCIP, AddTravelTitle1, AddTravelFName1, AddTravelMName1, AddTravelLName1, AddTravelDOB1, AddTravelNotes1, AddTravelTitle2, AddTravelFName2, AddTravelMName2, AddTravelLName2, AddTravelDOB2, AddTravelNotes2, AddTravelTitle3, AddTravelFName3, AddTravelMName3, AddTravelLName3, AddTravelDOB3, AddTravelNotes3, AddTravelTitle4, AddTravelFName4, AddTravelMName4, AddTravelLName4, AddTravelDOB4, AddTravelNotes4, AddTravelTitle5, AddTravelFName5, AddTravelMName5, AddTravelLName5, AddTravelDOB5, AddTravelNotes5, AddTravelTitle6, AddTravelFName6, AddTravelMName6, AddTravelLName6, AddTravelDOB6, AddTravelNotes6, AddTravelTitle7, AddTravelFName7, AddTravelMName7, AddTravelLName7, AddTravelDOB7, AddTravelNotes7, AddTravelTitle8, AddTravelFName8, AddTravelMName8, AddTravelLName8, AddTravelDOB8, AddTravelNotes8, TripGrandTotal, InsuranceGrandTotal, OverallGrandTotal, ServiceGrandTotal, TravelerDocuments1, TravelerDocuments2, TravelerDocuments3, 
TravelerDocuments4, TravelerDocuments5, QuoteFee1, BookingFee1, TripFee1, TravelInsuranceFee1, QuoteFee2, BookingFee2, TripFee2, TravelInsuranceFee2, QuoteFee3, BookingFee3, TripFee3, TravelInsuranceFee3, QuoteFee4, BookingFee4, TripFee4, TravelInsuranceFee4)
SELECT '', '".$BookUnique."',AgentID, BookingCIP, AddTravelTitle1, AddTravelFName1, AddTravelMName1, AddTravelLName1, AddTravelDOB1, AddTravelNotes1, AddTravelTitle2, AddTravelFName2, AddTravelMName2, AddTravelLName2, AddTravelDOB2, AddTravelNotes2, AddTravelTitle3, AddTravelFName3, AddTravelMName3, AddTravelLName3, AddTravelDOB3, AddTravelNotes3, AddTravelTitle4, AddTravelFName4, AddTravelMName4, AddTravelLName4, AddTravelDOB4, AddTravelNotes4, AddTravelTitle5, AddTravelFName5, AddTravelMName5, AddTravelLName5, AddTravelDOB5, AddTravelNotes5, AddTravelTitle6, AddTravelFName6, AddTravelMName6, AddTravelLName6, AddTravelDOB6, AddTravelNotes6, AddTravelTitle7, AddTravelFName7, AddTravelMName7, AddTravelLName7, AddTravelDOB7, AddTravelNotes7, AddTravelTitle8, AddTravelFName8, AddTravelMName8, AddTravelLName8, AddTravelDOB8, AddTravelNotes8, TripGrandTotal, InsuranceGrandTotal, OverallGrandTotal, ServiceGrandTotal, TravelerDocuments1, TravelerDocuments2, TravelerDocuments3, 
TravelerDocuments4, TravelerDocuments5, QuoteFee1, BookingFee1, TripFee1, TravelInsuranceFee1, QuoteFee2, BookingFee2, TripFee2, TravelInsuranceFee2, QuoteFee3, BookingFee3, TripFee3, TravelInsuranceFee3, QuoteFee4, BookingFee4, TripFee4, TravelInsuranceFee4 FROM booking_2 WHERE BookID2='$BookID'";
...
//=====================================RECALL THE LAST BOOK ID ===================================================

$sql = "SELECT * FROM booking_1 WHERE BookUnique='".$BookUnique."' ";
...
$PTravellerEmail=($_POST['PTravellerEmail']);
...
$pricing1=sanitize_sql_string($_POST['pricing1']);
$pricing2=sanitize_sql_string($_POST['pricing2']);
$pricing3=sanitize_sql_string($_POST['pricing3']);
$pricing4=sanitize_sql_string($_POST['pricing4']);
$pricing5=sanitize_sql_string($_POST['pricing5']);
$insurance1=sanitize_sql_string($_POST['insurance1']);
$insurance2=sanitize_sql_string($_POST['insurance2']);
$insurance3=sanitize_sql_string($_POST['insurance3']);
$insurance4=sanitize_sql_string($_POST['insurance4']);
$insurance5=sanitize_sql_string($_POST['insurance5']);
...
$urllink='https://centreholidays.com/agents/booking-authorization-email-form-preview.php?BookID='.$BookID77.'&allow=no';


	$subject  = $EmaiToSubject;	
	$from     = $PTravellerEmail;	
	...
	$message1  = str_replace("_EmaiToFullName_", $EmaiToFullName, $message1); 
	$message1  = str_replace("_BusinessEmail_", $BusinessEmail, $message1); 
	$message1  = str_replace("_BusinessPhone_", $BusinessPhone, $message1); 
	$message1  = str_replace("_BusinessFullName_", $BusinessFullName, $message1); 
	$message1  = str_replace("_BusinessName_", $BusinessName, $message1); 
	$message1  = str_replace("_PTravellerFullName_", $SendPTravellerFullNamee, $message1); 
	$message1  = str_replace("_urllink_", $urllink, $message1); 
	$message1  = str_replace("_EmaiToSubject_", $EmaiToSubject, $message1);				
...
//=================================================================================================
	...
	$subject  = 'Payment By Bank Deposit / Email Transfer';	 
...
try {
	...
	$mail->AddAddress($PTravellerFullName, $SendEmaiToFullName);  // Add a recipient  to name
	$mail->AddAddress($PTravellerEmail, $BusinessName);  // additional to emails
