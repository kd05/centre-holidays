...
$ptime=time()-(60*60*24*3000000);// how far in the past change 10 to any number of days
$BookUnique=trim($_GET['bq']); //trim($_GET['tm']);//booking unique number
$BookingTime=time();
$BookingTime2=time();
if (!empty($BookUnique))
{
...
<input type="text" required name="PTravellerFName" value="" class="form-control  form-control-lg" placeholder="First Name" />
</div>
</div>
...
<input type="text" required value="" name="PTravellerLName" class="form-control  form-control-lg" placeholder="Last Name" />
</div>
</div>
...
<input type="text" required value="" name="PTravellerDOB" class="form-control form-control-lg" id="kt_datepicker_1" placeholder="Select Date">
</div>
</div>
...
<input type="text" required value="" name="PTravellerPhone" class="form-control  form-control-lg" placeholder="Phone" />
</div>
</div>
...
<input type="text" required value="" name="PTravellerEmail" class="form-control  form-control-lg" placeholder="Email" />
</div>
</div>
...
<input type="text" required value="" name="PTravellerStreet" class="form-control form-control-lg" placeholder="Street Address" />
</div>
</div>
...
<input type="text" required name="PTravellerCity" value="" class="form-control form-control-lg" placeholder="City" />
</div>
</div>
...
<input type="text" required name="PTravellerProvince" value="" class="form-control form-control-lg" placeholder="Province/State" />
</div>
</div>
...
<input type="text" required name="PTravellerPostal" value="" class="form-control form-control-lg" placeholder="Postal Code / Zip Code" />
</div>
</div>
...
<input type="text" required name="PTravellerCountry" value="" class="form-control form-control-lg" placeholder="Country" />
</div>
</div>
...
<div class="col-xl-3">
<div class="form-group">
<label>Additional Travellers In Party <span class="text-danger">*</span></label>
<select class="form-control  form-control-lg" name="PTravellerParty" id="select1" onchange="selectChanged1(); this.onclick=null" required > 
...
<input type="file" required onchange="ValidateSize(this)" name="PrimePassport" id="PrimePassport" />
</div>
</div>
</div>
</div>
...
<input type="text" name="QuoteNumberPersons" value="<?php echo $row["QuoteNumberPersons"] ?>" class="form-control form-control-lg bg-light" placeholder="Number Of Persons" readonly />
</div>
</div>
...
<div class="col-xl-4">
<div class="form-group">
<label>Quote Fee Total (Tax Included)</label>
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text">$</span>
</div>
...
?>
<input name="QuoteTotalFee" value="<?php echo $QuoteTotalFee.'.00' ?>" type="text" class="form-control form-control-lg bg-light-success" placeholder="Service Fee Total (Tax Inc.)" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $row["ServiceCurrency"] ?></span>
</div>
</div>																		
...
<div class="form-group">
<label>Number Of Persons</label>
<input type="text" name="BookingFeeNumberPersons" value="<?php echo $row["BookingFeeNumberPersons"] ?>" class="form-control form-control-lg bg-light" placeholder="Booking Number Of Persons" <?php echo $Servicereadonly ?> />
</div>
</div>
<!--end::SFA - Number Of Persons-->
...
<input name="BookingFeePerPerson" value="<?php echo $row["BookingFeePerPerson"]; ?>" type="text" class="form-control form-control-lg bg-light-warning" placeholder="Booking Fee Per Person" <?php echo $Servicereadonly ?> >
<div class="input-group-append">
...
<div class="col-xl-4">
<div class="form-group">
<label>Booking Fee Total (Tax Included)</label>
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text">$</span>
</div>
...
?>
<input name="BookingTotalFee" value="<?php echo $BookingTotalFee.'.00' ?>" type="text" class="form-control form-control-lg bg-light-success" placeholder="Booking Fee Total (Tax Inc.)" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $ServiceCurrency ?></span>
</div>
</div>																		
...
<?php if ( (($row["ServiceAgreementType"]=='Custom Service Fee Agreement') && !empty($row["ServiceDetails"])) || (($row["ServiceAgreementType"] !='Custom Service Fee Agreement') && empty($row["ServiceDetails"])) ) { ?>
<!--begin::SFA - Details-->
<div class="col-xl-12">
<div class="form-group">
...
<input type="radio" id="myCheck737" name="ServiceAccepted" value="No" onclick="myFunction737(), myFunctionReason()">
...
function myFunctionReason() {
  ...
  document.getElementById("servicereason").required = true;
...
<textarea name="ServiceNoReason" id="servicereason" class="form-control form-control-lg" rows="2" placeholder="Please Provide A Reason"></textarea>
</div>
</div>
<!--end::SFA - Reason-->
</div>
...
<div onClick="covid19(); this.onclick=null;" class="card-title font-size-h2 font-weight-bolder text-warning collapsed" data-toggle="collapse" data-target="#baf3" aria-expanded="false" aria-controls="baf3" role="button">
...
<div class="card-body lead pb-0 pt-3">
<p class="lead font-weight-bold">Please review the details provided and sign the waiver. All items marked with a red asterisk<span class="text-danger"> *</span> are required.</p>
<div class="row mt-10">
...
<input type="text" required name="CovidConsentName" id="CovidConsentName" value="" class="form-control form-control-lg" placeholder="Full Name (Primary Traveller)" />
</div>
</div>
...
<br />
<button type="button" id="sig-clearBtn" on class="btn btn-light-warning text-uppercase font-weight-bolder mt-2">Clear Signature</button>
<textarea id="sigdataUrl" name="sigdataUrl" rows="5" class="hidden">
<?php echo $_POST['sigdataUrl'] ?>
</textarea>
<?php if (!empty($_POST['sigdataUrl'])) { ?>
<img src="<?php echo $_POST['sigdataUrl'] ?>" alt="Signature" style="width:300px; height:auto; max-height:300px">
<?php } ?>
</div>
</div>
...
<input type="radio" checked name="CovidAccepted" id="myCheck7470" value="Yes" onClick="myFunction7470()">
...
<input type="radio" id="myCheck747" name="CovidAccepted" value="No" onclick="myFunction747(), Covidnotaccepted()">
...
function Covidnotaccepted() {
  alert("Please Provide A Reason. The Field Cannot Be Left Blank.");
  var x = document.getElementById("CovidNoReason").required = true;
...
<!--begin::Ribbon-->
<div class="ribbon ribbon-top mb-5">
<?php if ($row['BookingStatus'] ==1 || $row['BookingStatus'] ==2 || !empty($row['BookingTime5'])) { ?>	
<div class="ribbon-target bg-danger" style="top: -2px; left: 29px;">Please Review</div>
<?php } ?>
<?php if ($row['TripAccepted'] =='Yes' && empty($row['BookingTime5'])) { ?>	
<div class="ribbon-target bg-success" style="top: -2px; left: 29px;">Approved</div>
<?php } ?>
...
<input type="text" required name="Supplier" value="<?php echo $row['Supplier']; ?>" class="form-control form-control-lg bg-light" placeholder="Supplier" />
</div>
</div>
<!--end::Supplier-->
...
<div class="col-xl-12 mt-3 mb-5">
<label class="radio radio-outline radio-danger radio-lg radio-outline-2x">
<input type="radio" name="TripAccepted" id="myCheck767" value="No" onClick="myFunction767(), myFunctionReason2()">
...
function myFunctionReason2() {
  alert("Please Provide A Reason. The Field Cannot Be Left Blank.");
  document.getElementById("tripreason").required = true;
...
<div class="form-group">
<label>Please Provide A Reason</label>
<textarea name="TripNoReason" id="tripreason" class="form-control form-control-lg" rows="2" placeholder="Please Provide A Reason"></textarea>
</div>
</div>
...
<div class="card-body pb-0 pt-3">
<p class="lead font-weight-bold">Please review the details provided and select at least one pricing option. All items marked with a red asterisk<span class="text-danger"> *</span> that pertain to your pricing option selection(s) are required.</p>
<!--begin::Row-->
...
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product7[]" id="product17" value="<?php echo $row['PricePerPerson1'] ?>" type="checkbox" onclick="multiply(), totalIt7(),totalIt27(),subtrIt(),toggle17(this)" />
...
<input type="checkbox" name="pricing17" value="<?php echo $row['PricePerPerson1'] ?>" style="display:none">
<script>
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product[]" id="product1" value="<?php echo $row['TotalPrice1'] ?>" type="checkbox" onclick="totalIt(),totalIt2(),toggle1(this)" />
...
<input type="checkbox" name="pricing1" value="<?php echo $row['TotalPrice1'] ?>" style="display:none">
<script>
...
<div class="col-xl-12 mb-2 mt-3">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product7[]" id="product27" value="<?php echo $row['PricePerPerson2'] ?>" type="checkbox" onclick="multiply(), totalIt7(),totalIt27(),subtrIt(),toggle27(this)" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">Select this pricing option and apply it to the payment schedule. <span class="text-danger">*</span></small></label>
<input type="checkbox" name="pricing27" value="<?php echo $row['PricePerPerson2'] ?>" style="display:none">
<script>
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product[]" id="product2" value="<?php echo $row['TotalPrice2'] ?>" type="checkbox" onclick="totalIt(),totalIt2(),toggle2(this)" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
<input type="checkbox" name="pricing2" value="<?php echo $row['TotalPrice2'] ?>" style="display:none">
<script>
...
<div class="col-xl-12 mb-2 mt-3">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product7[]" id="product37" value="<?php echo $row['PricePerPerson3'] ?>" type="checkbox" onclick="multiply(), totalIt7(),totalIt27(),subtrIt(),toggle37(this)" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">Select this pricing option and apply it to the payment schedule. <span class="text-danger">*</span></small></label>
<input type="checkbox" name="pricing37" value="<?php echo $row['PricePerPerson3'] ?>" style="display:none">
<script>
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product[]" id="product3" value="<?php echo $row['TotalPrice3'] ?>" type="checkbox" onclick="totalIt(),totalIt2(),toggle3(this)" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
<input type="checkbox" name="pricing3" value="<?php echo $row['TotalPrice3'] ?>" style="display:none">
<script>
...
<div class="col-xl-12 mb-2 mt-3">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product7[]" id="product47" value="<?php echo $row['PricePerPerson4'] ?>" type="checkbox" onclick="multiply(), totalIt7(),totalIt27(),subtrIt(),toggle47(this)" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">Select this pricing option and apply it to the payment schedule. <span class="text-danger">*</span></small></label>
<input type="checkbox" name="pricing47" value="<?php echo $row['PricePerPerson4'] ?>" style="display:none">
<script>
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product[]" id="product4" value="<?php echo $row['TotalPrice4'] ?>" type="checkbox" onclick="totalIt(),totalIt2(),toggle4(this)" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
<input type="checkbox" name="pricing4" value="<?php echo $row['TotalPrice4'] ?>" style="display:none">
<script>
...
<div class="col-xl-12 mb-2 mt-3">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product7[]" id="product57" value="<?php echo $row['PricePerPerson5'] ?>" type="checkbox" onclick="multiply(), totalIt7(),totalIt27(),subtrIt(),toggle57(this)" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">Select this pricing option and apply it to the payment schedule. <span class="text-danger">*</span></small></label>
<input type="checkbox" name="pricing57" value="<?php echo $row['PricePerPerson5'] ?>" style="display:none">
<script>
function toggle37(source) {
checkboxes = document.getElementsByName('pricing37');
for (var i = 0, n = checkboxes.length; i < n; i++) {
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product[]" id="product5" value="<?php echo $row['TotalPrice5'] ?>" type="checkbox" onclick="totalIt(),totalIt2(),toggle5(this)" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
<input type="checkbox" name="pricing5" value="<?php echo $row['TotalPrice5'] ?>" style="display:none">
<script>
...
<p class="lead font-weight-bold">As per the selected pricing option(s), please review the payment schedule.</p>
</div>
...
<div class="col-xl-4">
<div class="form-group">
<label>Total Amount (Tax Included)</label>
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text">$</span>
</div>
<input name="TotalAmountDue" id="TotalAmountDue" value="0.00" class="form-control form-control-lg bg-light-success" placeholder="Total" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $TripPricingCurrency ?></span>
</div>
</div>																		
...
<input name="PaymentDue1" id="PaymentDue1" value="<?php echo $row['PaymentDue1']; ?>" type="text" class="form-control form-control-lg bg-light-warning" placeholder="Price Per Person" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $TripPricingCurrency ?></span>
</div>
</div>																		
...
<input name="PaymentDue2" id="PaymentDue2" value="<?php echo $row['PaymentDue2']; ?>" type="text" class="form-control form-control-lg bg-light-warning" placeholder="Price Per Person" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $TripPricingCurrency ?></span>
</div>
</div>																		
...
<input name="PaymentDue3" id="PaymentDue3" value="<?php echo $row['PaymentDue3']; ?>" type="text" class="form-control form-control-lg bg-light-warning" placeholder="Price Per Person" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $TripPricingCurrency ?></span>
</div>
</div>																		
...
<input name="PaymentDue4" id="PaymentDue4" value="<?php echo $row['PaymentDue4']; ?>" type="text" class="form-control form-control-lg bg-light-warning" placeholder="Price Per Person" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $TripPricingCurrency ?></span>
</div>
</div>																		
...
<!--begin::Pricing Schedule 5 - Amount PP-->
<div class="col-xl-3">
<div class="form-group">
<label>Price Per Person (Tax Included)</label>
<div class="input-group">
...
<input name="PaymentDue5" id="PaymentDue5" value="0.00" type="text" class="form-control form-control-lg bg-light-warning" placeholder="Price Per Person" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $TripPricingCurrency ?></span>
</div>
</div>																		
...
<!--end::Pricing Schedule 5 - Amount PP-->
...
<input id="result5" name="result5" value="0.00" type="text" class="form-control form-control-lg bg-light-success" placeholder="Total" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $TripPricingCurrency ?></span>
</div>
</div>																		
...
<!--Balance per person calculation display--------------------------->
<!--Balance per person calculation display--------------------------->
<!--Balance per person calculation display--------------------------->

<br />
Total Deposits <input class="form-control form-control-lg bg-light-success" type="number" readonly id="gresult" name="gresult" value="0.00"/>
<br />
Grand Total <input class="form-control form-control-lg bg-light-success" type="number" readonly id="gresultba" name="gresultba" value="0.00"/>
<br />
Total Balance <input class="form-control form-control-lg bg-light-success" type="number" readonly id="bgresultba" name="bgresultba" value="0.00"/>
<br />
Number Of Persons  <input class="form-control form-control-lg bg-light-success" type="number" readonly id="gresultdiv" name="gresultdiv" value="0.00"/>
<br />
Balance Per Person  <input class="form-control form-control-lg bg-light-success" type="number" readonly id="averperperson" style="color:#C00" name="averperperson" value="0.00"/>

<!--End Balance per person calculation display--------------------------->
<!--End Balance per person calculation display--------------------------->
<!--End Balance per person calculation display--------------------------->
...
function myFunctionReason3() {
  alert("Please Provide A Reason. The Field Cannot Be Left Blank.");
  var x = document.getElementById("pricingreason").required = true;
...
<div class="col-xl-12 mt-3 mb-5">
<label class="radio radio-outline radio-danger radio-lg radio-outline-2x">
<input type="radio" name="TermAccepted" value="No" id="myCheck777" onClick="myFunction777(), myFunctionReason45()">
...
function myFunctionReason45() {
  alert("Please Provide A Reason. The Field Cannot Be Left Blank.");
  var x = document.getElementById("TermNoReason").required = true;
...
<div class="form-group">
<label>Please Provide A Reason</label>
<textarea name="TermNoReason" id="TermNoReason" class="form-control form-control-lg" rows="2" placeholder="Please Provide A Reason"></textarea>
</div>
</div>
<!--end::T&C Reason-->
</div>
...
<div onClick="covid1999(); this.onclick=null;" class="card-title font-size-h2 font-weight-bolder text-warning collapsed" data-toggle="collapse" data-target="#baf7" aria-expanded="false" aria-controls="baf7" role="button">
...
<div class="col-xl-12 mt-3 mb-5">
<label class="radio radio-outline radio-danger radio-lg radio-outline-2x">
<input type="radio" name="CancelAccepted" id="myCheck977" onClick="myFunction977(), myFunctionReason5()" value="No">
...
function myFunctionReason5() {
  alert("Please Provide A Reason. The Field Cannot Be Left Blank.");
  var x = document.getElementById("CancelNoReason").required = true;
...
<div class="form-group">
<label>Please Provide A Reason</label>
<textarea name="CancelNoReason" id="CancelNoReason" class="form-control form-control-lg" rows="2" placeholder="Please Provide A Reason"></textarea>
</div>
</div>
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input type="checkbox" name="product77[]" value="<?php echo $row['InsuranceTotalPrice1']; ?>"onclick="totalIt77(),toggle11(this)" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
<input type="checkbox" name="insurance1" value="<?php echo $row['InsuranceTotalPrice1'] ?>" style="display:none">
<script>
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input type="checkbox" name="product77[]" value="<?php echo $row['InsuranceTotalPrice2']; ?>"onclick="totalIt77(),toggle12(this)" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
<input type="checkbox" name="insurance2" value="<?php echo $row['InsuranceTotalPrice2'] ?>" style="display:none">
<script>
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input type="checkbox" name="product77[]" value="<?php echo $row['InsuranceTotalPrice3']; ?>"onclick="totalIt77(),toggle13(this)" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
<input type="checkbox" name="insurance3" value="<?php echo $row['InsuranceTotalPrice3'] ?>" style="display:none">
<script>
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input type="checkbox" name="product77[]" value="<?php echo $row['InsuranceTotalPrice4']; ?>"onclick="totalIt77(),toggle14(this)" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
<input type="checkbox" name="insurance4" value="<?php echo $row['InsuranceTotalPrice4'] ?>" style="display:none">
<script>
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input type="checkbox" name="product77[]" value="<?php echo $row['InsuranceTotalPrice5']; ?>"onclick="totalIt77(),toggle15(this)" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
<input type="checkbox" name="insurance5" value="<?php echo $row['InsuranceTotalPrice5'] ?>" style="display:none">
<script>
...
<div class="col-xl-12 mt-3">
<label class="radio radio-outline radio-success radio-lg radio-outline-2x">
<input type="radio" checked onClick="myFunction444(), insuranceagreed()" id="myCheck444" name="InsuranceAccepted" value="Yes">
...
<div class="col-xl-12 mt-3">
<label class="radio radio-outline radio-danger radio-lg radio-outline-2x">
<input type="radio" name="InsuranceAccepted" id="myCheck445" onClick="myFunction445(), thereason()" value="No">
...
<div class="col-xl-12 mt-3 mb-5">
<label class="radio radio-outline radio-danger radio-lg radio-outline-2x">
<input type="radio" name="PurchaseInsurance" id="myCheck446" onClick="myFunction446(), weaver()" value="No">
...
<div class="form-group">
<label>Please Provide A Reason</label>
<textarea name="InsuranceNoReason" id="InsuranceNoReason" class="form-control form-control-lg" rows="2" placeholder="Please Provide A Reason"></textarea>
</div>
</div>
...
<div class="col-xl-12">
<label class="radio radio-outline radio-success radio-lg radio-outline-2x">
<input type="radio" onClick="myFunction4447()" id="myCheck4447" name="PurchaseInsurance" value="Yes">
...
<div class="col-xl-12 mt-3 mb-5">
<label class="radio radio-outline radio-danger radio-lg radio-outline-2x">
<input type="radio" name="PurchaseInsurance" id="myCheck4447" onClick="myFunction4447()" value="No">
...
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input type="checkbox" name="InsuranceWeaverConsent" id="InsuranceWeaverConsent" value="Yes">
...
<div class="form-group">
<label>Full Name (Primary Traveller) <span class="text-danger">*</span></label>
<input type="text" name="InsuranceWeaverConsentName" id="InsuranceWeaverConsentName" value="" class="form-control form-control-lg" placeholder="Full Name (Primary Traveller)" />
</div>
</div>
...
<?php echo $_POST['sigdataUrl1'] ?>
</textarea>
<?php if (!empty($_POST['sigdataUrl1'])) { ?>
<img src="<?php echo $_POST['sigdataUrl1'] ?>" alt="Signature" style="width:300px; height:auto; max-height:300px">
<?php } ?>
...
/*	if (sel1 == 8) {
	alert ("You Have Eight Additional Travellers, these fields are required Title, First Name, Last Name, Date Of Birth.");	
	}
	if (sel1 == 7) {
	alert ("You Have Seven Additional Travellers, these fields are required Title, First Name, Last Name, Date Of Birth.");	
	}
	if (sel1 == 6) {
	alert ("You Have Six Additional Travellers, these fields are required Title, First Name, Last Name, Date Of Birth.");	
	}
	if (sel1 == 5) {
	alert ("You Have Five Additional Travellers, these fields are required Title, First Name, Last Name, Date Of Birth.");	
	}
	if (sel1 == 4) {
	alert ("You Have Four Additional Travellers, these fields are required Title, First Name, Last Name, Date Of Birth.");	
	}
	if (sel1 == 3) {
	alert ("You Have Three Additional Travellers, these fields are required Title, First Name, Last Name, Date Of Birth.");	
	}
	if (sel1 == 2) {
	alert ("You Have Two Additional Travellers, these fields are required Title, First Name, Last Name, Date Of Birth.");	
	}*/
...
<div class="card-body pb-0 pt-3">
<p class="lead font-weight-bold">Please state each additional traveller's details as per their passport. If requested, please upload a copy of each additional traveller's passport in order to avoid any errors during the booking process. All items marked with a red asterisk<span class="text-danger"> *</span> are required.</p>
<!--begin::Row-->
...
<input type="text" name="AddTravelFName1" id="AddTravelFName1" value="" class="form-control  form-control-lg" placeholder="First Name" />
</div>
</div>
...
<input type="text" name="AddTravelMName1" id="AddTravelMName1" value="" class="form-control  form-control-lg" placeholder="Middle Name" />
</div>
</div>
...
<input type="text" name="AddTravelLName1" id="AddTravelLName1" value="" class="form-control  form-control-lg" placeholder="Last Name" />
</div>
</div>
...
<input type="text" onChange="" name="AddTravelDOB1" class="form-control form-control-lg" id="kt_datepicker_1" placeholder="Select Date" >
</div>
</div>
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="ValidateSize(this)" name="AddPassport1" id="AddPassport1" />
</div>
</div>
</div>
</div>
...
<input type="text" name="AddTravelFName2" id="AddTravelFName2" value="" class="form-control  form-control-lg" placeholder="First Name" />
</div>
</div>
...
<input type="text" name="AddTravelMName2" id="AddTravelMName2" value="" class="form-control  form-control-lg" placeholder="Middle Name" />
</div>
</div>
...
<input type="text" name="AddTravelLName2" id="AddTravelLName2" value="" class="form-control  form-control-lg" placeholder="Last Name" />
</div>
</div>
...
<input type="text" onChange="" name="AddTravelDOB2" class="form-control form-control-lg" id="kt_datepicker_1" placeholder="Select Date" >
</div>
</div>
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="ValidateSize(this)" name="AddPassport2" id="AddPassport2" />
</div>
</div>
</div>
</div>
...
<input type="text" name="AddTravelFName3" id="AddTravelFName3" value="" class="form-control  form-control-lg" placeholder="First Name" />
</div>
</div>
...
<input type="text" name="AddTravelMName3" id="AddTravelMName3" value="" class="form-control  form-control-lg" placeholder="Middle Name" />
</div>
</div>
...
<input type="text" name="AddTravelLName3" id="AddTravelLName3" value="" class="form-control  form-control-lg" placeholder="Last Name" />
</div>
</div>
...
<input type="text" onChange="" name="AddTravelDOB3" class="form-control form-control-lg" id="kt_datepicker_1" placeholder="Select Date" >
</div>
</div>
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="ValidateSize(this)" name="AddPassport3" id="AddPassport3" /></div>
</div>
</div>
</div>
...
<input type="text" name="AddTravelFName4" id="AddTravelFName4" value="" class="form-control  form-control-lg" placeholder="First Name" />
</div>
</div>
...
<input type="text" name="AddTravelMName4" id="AddTravelMName4" value="" class="form-control  form-control-lg" placeholder="Middle Name" />
</div>
</div>
...
<input type="text" name="AddTravelLName4" id="AddTravelLName4" value="" class="form-control  form-control-lg" placeholder="Last Name" />
</div>
</div>
...
<input type="text" onChange="" name="AddTravelDOB4" class="form-control form-control-lg" id="kt_datepicker_1" placeholder="Select Date" >
</div>
</div>
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="ValidateSize(this)" name="AddPassport4" id="AddPassport4" /></div>
</div>
</div>
</div>
...
<input type="text" name="AddTravelFName5" id="AddTravelFName5" value="" class="form-control  form-control-lg" placeholder="First Name" />
</div>
</div>
...
<input type="text" name="AddTravelMName5" id="AddTravelMName5" value="" class="form-control  form-control-lg" placeholder="Middle Name" />
</div>
</div>
...
<input type="text" name="AddTravelLName5" id="AddTravelLName5" value="" class="form-control  form-control-lg" placeholder="Last Name" />
</div>
</div>
...
<input type="text" onChange="" name="AddTravelDOB5" class="form-control form-control-lg" id="kt_datepicker_1" placeholder="Select Date" >
</div>
</div>
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="ValidateSize(this)" name="AddPassport5" id="AddPassport5" /></div>
</div>
</div>
</div>
...
<input type="text" name="AddTravelFName6" value="" class="form-control  form-control-lg" placeholder="First Name" />
</div>
</div>
...
<input type="text" name="AddTravelMName6" value="" class="form-control  form-control-lg" placeholder="Middle Name" />
</div>
</div>
...
<input type="text" name="AddTravelLName6" value="" class="form-control  form-control-lg" placeholder="Last Name" />
</div>
</div>
...
<input type="text" onChange="" name="AddTravelDOB6" class="form-control form-control-lg" id="kt_datepicker_1" placeholder="Select Date" >
</div>
</div>
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="ValidateSize(this)" name="AddPassport6" id="AddPassport6" /></div>
</div>
</div>
</div>
...
<input type="text" name="AddTravelFName7" value="" class="form-control  form-control-lg" placeholder="First Name" />
</div>
</div>
...
<input type="text" name="AddTravelMName7" value="" class="form-control  form-control-lg" placeholder="Middle Name" />
</div>
</div>
...
<input type="text" name="AddTravelLName7" value="" class="form-control  form-control-lg" placeholder="Last Name" />
</div>
</div>
...
<input type="text" onChange="" name="AddTravelDOB7" class="form-control form-control-lg" id="kt_datepicker_1" placeholder="Select Date" >
</div>
</div>
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="ValidateSize(this)" name="AddPassport7" id="AddPassport7" /></div>
</div>
</div>
</div>
...
<input type="text" name="AddTravelFName8" value="" class="form-control  form-control-lg" placeholder="First Name" />
</div>
</div>
...
<input type="text" name="AddTravelMName8" value="" class="form-control  form-control-lg" placeholder="Middle Name" />
</div>
</div>
...
<input type="text" name="AddTravelLName8" value="" class="form-control  form-control-lg" placeholder="Last Name" />
</div>
</div>
...
<input type="text" onChange="" name="AddTravelDOB8" class="form-control form-control-lg" id="kt_datepicker_1" placeholder="Select Date" >
</div>
</div>
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="ValidateSize(this)" name="AddPassport8" id="AddPassport8" /></div>
</div>
</div>
</div>
...
<div class="col-xl-12 mt-3">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input type="checkbox" name="AddTravelConsent1" id="AddTravelConsent1" value="Yes">
...
<div class="col-xl-12 mt-5 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input type="checkbox"  name="AddTravelConsent2" id="AddTravelConsent2" value="Yes">
...
$AdditionalConsentchecked='checked';
?>
<!--begin::Row-->
<div class="row">
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input onChange="validatepricing290()" type="checkbox" <?php echo $AdditionalConsentchecked ?> name="AdditionalConsent" id="AdditionalConsent" value="Yes">
...
$DBTotal=trim(number_format($DBTotal, 2, '.', ''));
...
<!--begin::Ribbon-->
<div class="ribbon ribbon-top mb-5">
<?php if ($row['DetailsCorrectConsent'] =='Yes' && $row['VerificationPurposesConsent'] =='Yes') { ?>	
<div class="ribbon-target bg-success" style="top: -2px; left: 29px;">Approved</div>
<?php } else { ?>
<div class="ribbon-target bg-danger" style="top: -2px; left: 29px;">Please Review</div>
<?php } ?>
...
<div class="card-body pb-0 pt-3">
<p class="lead font-weight-bold">Please review the pricing totals, select up to two methods of payment and fill in any required details. All items marked with a red asterisk<span class="text-danger"> *</span> are required.</p>
<!--begin::Row-->
<div class="row mt-10">
...
<div class="col-xl-6">
<div class="form-group">
<label>Quote Fee Grand Total (Tax Included)</label>
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text">$</span>
</div>
...
$QuoteTotalFee=$QuoteTotalFee.'.00';
else
$QuoteTotalFee='0.00';
?>
<input name="QuoteTotalFee" id="sgt" value="<?php echo $QuoteTotalFee ?>" type="text" class="form-control form-control-lg bg-light-success" placeholder="Quote Fee Grand Total (Tax Included)" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $ServiceCurrency ?></span>
</div>
</div>																		
...
<div class="col-xl-6">
<div class="form-group">
<label>Booking Fee Grand Total (Tax Included)</label>
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text">$</span>
</div>
...
$BookingTotalFee=$BookingTotalFee.'.00';
else
$BookingTotalFee='0.00';
?>
<input name="BookingTotalFee" id="sgt0" value="<?php echo $BookingTotalFee ?>" type="text" class="form-control form-control-lg bg-light-success" placeholder="Booking Fee Grand Total (Tax Included)" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $ServiceCurrency ?></span>
</div>
</div>																		
...
<?php if (empty($row['FullPaymentDate'])) { ?>
<input value="0.00" name="total" id="total" onChange="totalIt()" class="form-control form-control-lg bg-light-success" placeholder="Trip Grand Total (Tax Included)" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $TripPricingCurrency ?></span>
</div>
<?php } else { ?>
<input value="0.00" name="TotalAmountDue3" id="TotalAmountDue3" onChange="totalIt2()" class="form-control form-control-lg bg-light-success" placeholder="Trip Grand Total (Tax Included)" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $TripPricingCurrency ?></span>
</div>
<?php }  ?>
...
<input name="InsuranceGrandTotal" id="igt" value="0.00" type="text" class="form-control form-control-lg bg-light-success" placeholder="Travel Insurance Grand Total (Tax Included)" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $InsuranceCurrency ?></span>
</div>
</div>																		
...
<input value="" type="checkbox" name="MethodOfPayment" id="myCheck9991" onclick="myFunction99917(), myFunction9991(), toggle199(this), my1Function9991()"><span></span>Credit Card</label>
...
<input type="checkbox" name="MethodOfPayment1" value="Credit Card" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input value="" type="checkbox" name="MethodOfPayment" id="myCheck9992" onclick="myFunction9992(), toggle299(this), my2Function9992(), toggle171(this), toggle172(this), toggle173(this), toggle174(this)"><span></span>Bank Deposit Into Centre Holidays' Account</label>
...
<input type="checkbox" name="MethodOfPayment2" value="Deposit Money Into Centre Holidays Bank Account" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input value="" type="checkbox" name="MethodOfPayment" id="myCheck9993" onclick="myFunction9993(), toggle399(this), my3Function9993()"><span></span>Email Transfer</label>
...
<input type="checkbox" name="MethodOfPayment3" value="Email Transfer" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input value="" type="checkbox" name="MethodOfPayment" id="myCheck9994" onclick=" myFunction9994(), toggle499(this), my4Function9994()"><span></span>Trip Financing Through Uplift</label>
...
<input type="checkbox" name="MethodOfPayment4" value="Trip Financing Through Uplift" style="display:none">
...
<!--end::Row-->
<!--begin::Row-->
<div class="row" id="text9992" style="display:none">
<!--begin::Separator-->
<div class="col-xl-12">
...
<div class="checkbox-list mb-5 text-dark font-weight-bold">
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" onclick="toggle171(this)" class="example2" name="PayingFor" id="myCheck1" value="Quote Fee">
<span></span>Quote Fee</label>
<input type="checkbox" name="QuoteFee1" id="QuoteFee1" value="Quote Fee With Bank Deposit" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" onclick="toggle172(this)" class="example2" name="PayingFor" id="myCheck2" value="Booking Fee">
<span></span>Booking Fee</label>
<input type="checkbox" name="BookingFee1" id="BookingFee1" value="Booking Fee With Bank Deposit" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" onclick="toggle173(this)" class="example2" name="PayingFor" id="myCheck3" value="Trip">
<span></span>Trip</label>
<input type="checkbox" name="TripFee1" id="TripFee1" value="Trip With Bank Deposit" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" onclick="toggle174(this)" class="example2" name="PayingFor" id="myCheck4" value="Travel Insurance">
<span></span>Travel Insurance</label>
<input type="checkbox" name="TravelInsuranceFee1" id="TravelInsuranceFee1" value="Travel Insurance With Bank Deposit" style="display:none">
<script>
...
<!--begin::Bank Deposit-->
<div class="col-xl-12" >
<div class="card card-custom card-border bg-light mb-8 mt-10">
  <div class="card-body lead pt-8 text-dark">
  <div class="card-scroll">
...
<!--end::Row-->
<!--begin::Row-->
<div class="row" id="text9993" style="display:none">
<!--begin::Separator-->
<div class="col-xl-12">
<div class="separator separator-dashed mb-8 separator-border-3"></div>
</div>
...
<div class="checkbox-list mb-5 text-dark font-weight-bold">
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" onclick="toggle181(this)" class="example3" name="PayingFor" id="myCheck5" value="Quote Fee">
<span></span>Quote Fee</label>
<input type="checkbox" name="QuoteFee2" id="QuoteFee2" value="Quote Fee With Email Transfer" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" onclick="toggle182(this)" class="example3" name="PayingFor" id="myCheck6" value="Booking Fee">
<span></span>Booking Fee</label>
<input type="checkbox" name="BookingFee2" id="BookingFee2" value="Booking Fee With Email Transfer" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" class="example3" onclick="toggle183(this)" name="PayingFor" id="myCheck7" value="Trip">
<span></span>Trip</label>
<input type="checkbox" name="TripFee2" id="TripFee2" value="Trip With Email Transfer" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" class="example3" onclick="toggle184(this)" name="PayingFor" id="myCheck8" value="Travel Insurance">
<span></span>Travel Insurance</label>
<input type="checkbox" name="TravelInsuranceFee2" id="TravelInsuranceFee2" value="Travel Insurance With Email Transfer" style="display:none">
<script>
...
<!--begin::Row-->
<div class="row" id="text9994" style="display:none">
<!--begin::Separator-->
<div class="col-xl-12">
<div class="separator separator-dashed mb-8 separator-border-3"></div>
</div>
...
<div class="checkbox-list mb-5 text-dark font-weight-bold">
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" onclick="toggle191(this)" class="example4" name="PayingFor" id="myCheck9" value="Quote Fee">
<span></span>Quote Fee</label>
<input type="checkbox" name="QuoteFee3" id="QuoteFee3" value="Quote Fee With Trip Financing" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" onclick="toggle192(this)" class="example4" name="PayingFor" id="myCheck10" value="Booking Fee">
<span></span>Booking Fee</label>
<input type="checkbox" name="BookingFee3" id="BookingFee3" value="Booking Fee With Trip Financing" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" class="example4" onclick="toggle193(this)" name="PayingFor" id="myCheck11" value="Trip">
<span></span>Trip</label>
<input type="checkbox" name="TripFee3" id="TripFee3" value="Trip With Trip Financing" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" class="example4" onclick="toggle194(this)" name="PayingFor" id="myCheck12" value="Travel Insurance">
<span></span>Travel Insurance</label>
<input type="checkbox" name="TravelInsuranceFee3" id="TravelInsuranceFee3" value="Travel Insurance With Trip Financing" style="display:none">
<script>
...
<div class="card card-custom card-border bg-light mb-8 mt-10">
  <div class="card-body lead pt-8 text-dark">
  <div class="card-scroll">
<p>Your travel advisor will contact you with the necessary steps for trip financing.</p>
</div>
</div>
</div>
</div>
...
<div id="text9991" style="display:none">
<div class="row">
<!--begin::Separator-->
<div class="col-xl-12">
<div class="separator separator-dashed mb-8 separator-border-3"></div>
...
<div class="checkbox-list mb-5 text-dark font-weight-bold">
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" class="example1" onClick="toggle1101(this)" name="PayingFor" id="myCheck13">
<span></span>Quote Fee</label>
<input type="checkbox" name="QuoteFee4" id="QuoteFee4" value="Quote Fee With Credit Card" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" class="example1" onClick="toggle1102(this)" name="PayingFor" id="myCheck14">
<span></span>Booking Fee</label>
<input type="checkbox" name="BookingFee4" id="BookingFee4" value="Booking Fee With Credit Card" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" onClick="toggle1103(this)" class="example1" name="PayingFor" id="myCheck15">
<span></span>Trip</label>
<input type="checkbox" name="TripFee4" id="TripFee4" value="Trip With Credit Card" style="display:none">
<script>
...
<label class="checkbox checkbox-outline checkbox-warning checkbox-lg checkbox-outline-2x">
<input type="checkbox" onClick="toggle1104(this)" class="example1" name="PayingFor" id="myCheck16">
<span></span>Travel Insurance</label>
<input type="checkbox" name="TravelInsuranceFee4" id="TravelInsuranceFee4" value="Travel Insurance With Credit Card" style="display:none">
<script>
...
{
?>
<option value="700">I Am Travelling</option>
<?php	
}
?>
...
<input type="text" name="CCName" id="CCName" value="" class="form-control  form-control-lg" placeholder="Name On Credit Card" />
</div>
</div>
...
<input type="text" name="CCNumber" id="CCNumber" value="" class="form-control  form-control-lg" placeholder="Credit Card Number" />
</div>
</div>
...
<input type="text" name="CCExpiry" id="CCExpiry" value="" class="form-control form-control-lg" placeholder="Expiry Date" />
</div>
</div>
<!--end::Expiry Date-->
<!--begin::CVV Number-->
...
<input type="text" name="CCVV" id="CCVV" value="" class="form-control  form-control-lg" placeholder="CVV Number" />
</div>
</div>
<!--end::CVV Number-->
...
<input type="text" name="CCPhone" id="CCPhone" value="" class="form-control  form-control-lg" placeholder="Card Holder's Phone" />
</div>
</div>
...
<input type="text" name="CCEmail" id="CCEmail" value="" class="form-control form-control-lg" placeholder="Card Holder's Email" />
</div>
</div>
...
<input type="text" name="CCAddress" id="CCAddress" value="" class="form-control  form-control-lg" placeholder="Billing Address (Street)" />
</div>
</div>
...
<div class="form-group">
<label>City <span class="text-danger">*</span></label>
<input type="text" name="CCCity" id="CCCity" value="" class="form-control form-control-lg" placeholder="City" />
</div>
</div>
...
<div class="form-group">
<label>Province / State <span class="text-danger">*</span></label>
<input type="text" name="CCProvince" id="CCProvince" value="" class="form-control  form-control-lg" placeholder="Province / State" />
</div>
</div>
...
<div class="form-group">
<label>Postal Code / Zip Code <span class="text-danger">*</span></label>
<input type="text" name="CCPostal" id="CCPostal" value="" class="form-control  form-control-lg" placeholder="Postal Code / Zip Code" />
</div>
</div>
...
<div class="form-group">
<label>Country <span class="text-danger">*</span></label>
<input type="text" name="CCCountry"  id="CCCountry" value="" class="form-control form-control-lg" placeholder="Country" />
</div>
</div>
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="ValidateSize(this)" name="CCFront" id="TripDetailsPDF" />
</div>
</div>
</div>
</div>
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="ValidateSize(this)"  name="CCBack" id="TripDetailsPDF" />
</div>
</div>
</div>
</div>
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="ValidateSize(this)"  name="GovernmentID" id="TripDetailsPDF" />
</div>
</div>
</div>
</div>
...
<div class="col-xl-12 mt-5" id="text99917" style="display:none">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input type="checkbox" name="CreditCardProcessConsent" id="CreditCardProcessConsent" value="Yes">
...
<div class="row justify-content-center text-center py-8 px-8 py-md-2 px-md-0">
...
<button type="button" class="btn btn-lg btn-warning font-weight-bolder text-uppercase mr-5" onclick="window.print();">Print</button>
<!--, validatepricing() onclick="DisplayFunction()"-->
<button type="submit" id="sig-submitBtn" class="btn btn-lg btn-success font-weight-bolder text-uppercase">Submit</button>
<script>
