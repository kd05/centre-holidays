...
<!--begin::Main-->
<form action="booking-authorization-clients-insert-shareable-link.php" enctype="multipart/form-data" method="post">
...
<input type="hidden" value="<?php echo $row['AgentID']; ?>" name="AgentID" />
<input type="hidden" value="<?php echo $row['GroupName']; ?>" name="GroupName" />
<input type="hidden" value="<?php echo $row['AgentUniqID']; ?>" name="AgentUniqID" />
...
function myFunction(e) {
	...
	document.getElementById("QuoteTotalFee").value = twise.toFixed(2);
	document.getElementById("sgt").value = twise2.toFixed(2);
	<?php } ?>
	}
}
...
<input type="file" onchange="Filevalidation()" name="PrimePassport" id="PrimePassport" />
<input type="hidden" value="<?php echo $row['PrimePassport'] ?>" name="PrimePassportDB" id="PrimePassportDB" />
<script>
Filevalidation =() => {
	const fi = document.getElementById('PrimePassport');
...
?>
<input name="QuoteTotalFee" id="QuoteTotalFee" value="<?php echo $QuoteTotalFee.'.00' ?>" type="text" class="form-control form-control-lg bg-light-success" placeholder="Service Fee Total (Tax Inc.)" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $row["ServiceCurrency"] ?></span>
</div>
</div>																		
...
?>
<input name="BookingTotalFee" id="BookingTotalFee" value="<?php echo $BookingTotalFee.'.00' ?>" type="text" class="form-control form-control-lg bg-light-success" placeholder="Booking Fee Total (Tax Inc.)" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $ServiceCurrency ?></span>
</div>
</div>																		
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product[]" id="product1" value="<?php echo $row['TotalPrice1'] ?>" type="checkbox" onclick="toggle1(this), totalIt(),totalIt2(),fmultiply()" />
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product[]" id="product2" value="<?php echo $row['TotalPrice2'] ?>" type="checkbox" onclick="toggle2(this), totalIt(),totalIt2(),fmultiply()" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product[]" id="product3" value="<?php echo $row['TotalPrice3'] ?>" type="checkbox" onclick="toggle3(this), totalIt(),totalIt2(),fmultiply()" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product[]" id="product4" value="<?php echo $row['TotalPrice4'] ?>" type="checkbox" onclick="toggle4(this), totalIt(),totalIt2(),fmultiply()" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
...
<div class="col-xl-12 mt-3 mb-5">
<label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
<input name="product[]" id="product5" value="<?php echo $row['TotalPrice5'] ?>" type="checkbox" onclick="toggle5(this), totalIt(),totalIt2(),fmultiply()" />
<span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
...
<input type="text" id="gresultdiv0" name="gresultdiv0" value="0" class="form-control form-control-lg bg-light" placeholder="Total Number Of Persons" readonly />
</div>
</div>
...
<input name="TotalAmountDue" id="TotalAmountDue" value="0.00" class="form-control form-control-lg bg-light-success" placeholder="Grand Total" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $TripPricingCurrency ?></span>
</div>
</div>																		
...
<input class="form-control form-control-lg bg-light-success" type="number" id="bgresultba" name="bgresultba" value="0.00" placeholder="Total Balance" readonly/>
<div class="input-group-append">
<span class="input-group-text"><?php echo $TripPricingCurrency ?></span>
</div>
</div>																		
...
<div class="col-xl-12 mt-3">
<label class="radio radio-outline radio-success radio-lg radio-outline-2x">
<input type="radio" checked onClick="myFunction444(), insuranceagreed(), uncheckoptions1()" id="myCheck444" name="InsuranceAccepted" value="Yes">
...
<div class="col-xl-12 mt-3">
<label class="radio radio-outline radio-danger radio-lg radio-outline-2x">
<input type="radio" name="InsuranceAccepted" id="myCheck445" onClick="uncheckoptions2(), myFunction445(), thereason()" value="No">
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="Filevalidation1()" name="AddPassport1" id="AddPassport1" />
<input type="hidden" value="<?php echo $row['AddPassport1'] ?>" name="AddPassport1DB" id="AddPassport1DB" />
<script>
Filevalidation1 =() => {
	const fi1 = document.getElementById('AddPassport1');
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="Filevalidation2()" name="AddPassport2" id="AddPassport2" />
<input type="hidden" value="<?php echo $row['AddPassport2'] ?>" name="AddPassport2DB" id="AddPassport2DB" />
<script>
Filevalidation2 =() => {
	const fi2 = document.getElementById('AddPassport2');
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="Filevalidation3()" name="AddPassport3" id="AddPassport3" /></div>
<input type="hidden" value="<?php echo $row['AddPassport3'] ?>" name="AddPassport3DB" id="AddPassport3DB" />
<script>
Filevalidation3 =() => {
	const fi3 = document.getElementById('AddPassport3');
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="Filevalidation4()" name="AddPassport4" id="AddPassport4" /></div>
<input type="hidden" value="<?php echo $row['AddPassport4'] ?>" name="AddPassport4DB" id="AddPassport4DB" />
<script>
Filevalidation4 =() => {
	const fi4 = document.getElementById('AddPassport4');
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="Filevalidation5()" name="AddPassport5" id="AddPassport5" /></div>
<input type="hidden" value="<?php echo $row['AddPassport5'] ?>" name="AddPassport5DB" id="AddPassport5DB" />
<script>
Filevalidation5 =() => {
	const fi5 = document.getElementById('AddPassport5');
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="Filevalidation6()" name="AddPassport6" id="AddPassport6" /></div>
<input type="hidden" value="<?php echo $row['AddPassport6'] ?>" name="AddPassport6DB" id="AddPassport6DB" />
<script>
Filevalidation6 =() => {
	const fi6 = document.getElementById('AddPassport6');
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="Filevalidation7()" name="AddPassport7" id="AddPassport7" /></div>
<input type="hidden" value="<?php echo $row['AddPassport7'] ?>" name="AddPassport7DB" id="AddPassport7DB" />
<script>
Filevalidation7 =() => {
	const fi7 = document.getElementById('AddPassport7');
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="Filevalidation8()" name="AddPassport8" id="AddPassport8" /></div>
<input type="hidden" value="<?php echo $row['AddPassport8'] ?>" name="AddPassport8DB" id="AddPassport8DB" />
<script>
Filevalidation8 =() => {
	const fi8 = document.getElementById('AddPassport8');
...
<?php } else { ?>
<input value="0.00" name="TotalAmountDue3" id="TotalAmountDue3" onChange="totalIt2()" class="form-control form-control-lg bg-light-success" placeholder="Trip Grand Total (Tax Inc.)" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $TripPricingCurrency ?></span>
</div>
<?php }  ?>
...
<input name="InsuranceGrandTotal" id="igt" value="0.00" type="text" class="form-control form-control-lg bg-light-success" placeholder="Travel Insurance Grand Total (Tax Inc.)" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $InsuranceCurrency ?></span>
</div>
</div>																		
...
<div class="alert-text lead">If Centre Holidays Inc. has to process any credit card payments in-house, there will be an additional transaction fee (added to the total) of 3.5% for VISA or Mastercard and 4% for AMEX. Your travel advisor will notify you accordingly before processing your credit card.</div>
</div>
<!--end::Important Alert-->
</div>
	...
	const fi10 = document.getElementById('CCFront');
		if (fi10.files.length > 0) {
			for (const i = 0; i <= fi10.files.length - 1; i++) {
				...
				if (file >= 2048) {
					alert(
					"Front Of Credit file too Big, please select a file less than 2mb");
				}  
			}
		}
...
<div class="dropzone dropzone-default dropzone-warning">
<div class="dropzone-msg dz-message needsclick">
<input type="file" onchange="Filevalidation11()"  name="CCBack" id="CCBack" />
<script>
Filevalidation11 =() => {
