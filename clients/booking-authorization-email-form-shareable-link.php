...
$BookingTotalFee='0.00';
?>
<input name="BookingTotalFee" id="sgt0" value="<?php echo number_format((float)$BookingTotalFee, 2, '.', ''); ?>" type="text" class="form-control form-control-lg bg-light-success" placeholder="Booking Fee Grand Total (Tax Inc.)" readonly >
<div class="input-group-append">
<span class="input-group-text"><?php echo $ServiceCurrency ?></span>
</div>
</div>																		
