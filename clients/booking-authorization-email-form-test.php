...
<?php 
	...
	{
	?>
	<option value="50">I Am Travelling</option><!--700-->
	<?php	
	}
...
<input type="text" onChange="myFunction()" name="CCNSHOW" id="CCNSHOW" value="<?php echo $CCNSHOW ?>" class="form-control form-control-lg" placeholder="Credit Card Number" />
