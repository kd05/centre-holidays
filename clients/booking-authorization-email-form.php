                        ...
                        if(0) {  ?>
                            ...
                            <div class="card border p-6">
                                ...
                                <div class="card-header" id="baf-heading3">
                                    <div onClick="covid19(); this.onclick=null;" class="card-title collapsed" data-toggle="collapse"
                                         data-target="#baf3" aria-expanded="false" aria-controls="baf3" role="button">
                                        <div class="card-label font-size-h2 font-weight-boldest text-uppercase text-warning">COVID-19 Waiver
                                        </div>
                                    </div>
                                </div>
                                <!--end::Header-->
                                ...
                                <div id="baf3" class="collapse" aria-labelledby="baf-heading3" data-parent="">
                                    <div class="card-body lead pb-0 pt-3">
                                        <p class="font-weight-bolder">Please review the details provided and sign the waiver. All items marked
                                            with a red asterisk<span class="text-danger"> *</span> are required.</p>
                                        <div class="row mt-10">
                                                    ...
                                                    <div class="card-body lead pt-8 text-dark">
                                                        <div class="card-scroll">
                                                            <p>As the worldwide COVID-19 pandemic remains ongoing at this time, I acknowledge
                                                                that for this reason, and other reasons not reasonably foreseeable at this time,
                                                                these travel plans may be interrupted or canceled by the supplier that is
                                                                providing them, a government entity or other third party over which Centre
                                                                Holidays Inc. has no control.
                                                                I further acknowledge that the supplier's own cancellation, re-booking and
                                                                refund policies, subject to any
                                                                applicable law that is now or may later be in effect, will govern my rights and
                                                                remedies, including my right to
                                                                receive a refund, in such an event. Moreover, I understand that should I elect
                                                                to purchase travel insurance, the terms of the policy will dictate whether, and
                                                                to what extent, coverage for any financial loss may exist under the
                                                                circumstances. By signing below, I hereby agree to hold Centre Holidays Inc.
                                                                harmless and release the agency from any and all liability for any damages,
                                                                including but not limited to monetary losses, I may incur as a result of such
                                                                interruption or cancellation of these travel plans.
                                                                <br>
                                                                <br>
                                                                By signing this agreement, I acknowledge the contagious nature of COVID-19 and
                                                                voluntarily assume the risk that I may be exposed to or infected by COVID-19
                                                                while traveling. Such exposure or infection may result in personal injury,
                                                                illness, permanent disability, and possible death. I voluntarily agree to assume
                                                                all of the foregoing risks and accept sole responsibility for any injury to
                                                                myself (including, but not limited to, personal injury, disability, and death),
                                                                illness, damage, loss, claim, liability, or expense, of any kind, that I may
                                                                experience or incur in connection with Centre Holidays Inc.
                                                                <br>
                                                                <br>
                                                                ...
                                                                excursions have established COVID-19 safety measures and precautions which may
                                                                change from day to day. These safety measures may include, but are not limited
                                                                to: curfews, attraction closings and reduced hours, size of group gatherings,
                                                                social distancing requirements, health screenings, self-quarantine requirements
                                                                and COVID test results. By signing this agreement, I accept ultimate
                                                                responsibility for myself and my travelling party to have all the necessary
                                                                provisions for travel (such as COVID test results, pre-travel questionnaires,
                                                                etc.) Moreover, I understand that I should assume responsibility for the
                                                                necessary documents (such as COVID test results, pre-travel questionnaires,
                                                                etc.) considering COVID-19, in order to travel to my specific destination.
                                                                <br>
                                                                <br>
                                                                By signing this agreement, I acknowledge that the signature provided below will
                                                                serve as my digital signature if signed through a third-party website.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12" id="text3667">
                                                ...
                                                <div class="col-xl-12 p-0">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" required name="CovidConsentName" id="CovidConsentName"
                                                               value="<?php echo $row["CovidConsentName"] ?>"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <?php if (empty($row['sigdataUrl'])) { ?>
                                                            <canvas id="sig-canvas"
                                                                    style="touch-action: none; width:100%; height:160px; max-width:300px">
                                                                Please download Chrome browser.
                                                            </canvas>
                                                            <br/>
                                                            <button type="button" id="sig-clearBtn" on
                                                                    class="btn btn-outline-warning btn-light-warning text-uppercase font-weight-bolder mt-2">
                                                                Clear Signature
                                                            </button>
                                                        <?php } ?>
...
<?php echo $row['sigdataUrl'] ?>
                                                        ...
                                                        <?php if (!empty($row["sigdataUrl"])) { ?>
                                                            <img src="<?php echo $row['sigdataUrl'] ?>" alt="Signature"
                                            ...
                                            <div class="col-xl-12 mt-3">
                                                <label class="radio radio-outline radio-success radio-lg radio-outline-2x">
                                                    <input type="radio" checked name="CovidAccepted" id="myCheck7470" value="Yes"
                                                           onClick="myFunctiondivs(), myFunction7470()">
                                                    <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">I agree to
                                                        the COVID-19 Waiver.</small></label>
                                            </div>
                                            ...
                                            <div class="col-xl-12 mt-3 mb-5">
                                                <label class="radio radio-outline radio-danger radio-lg radio-outline-2x">
                                                    <input type="radio" id="myCheck747" name="CovidAccepted" value="No"
                                                           onclick="myFunctiondivs(), myFunction747(), Covidnotaccepted()">
                                                    <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">I do not
                                            ...
                                            <div class="col-xl-12 mt-2" id="text747" style="display:none">
                                                <div class="form-group">
                                                    <label>Please Provide A Reason</label>
                                                    <textarea name="CovidNoReason" id="CovidNoReason" class="form-control form-control-lg"
                                                              rows="2" placeholder="Please Provide A Reason"></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body pb-0 pt-3">
                                            ...
                                            <div class="row mt-10 <?php echo $option1class ?>">
                                                ...
                                                <?php if (empty($row['FullPaymentDate'])) { ?>
                                                    ...
                                                    <div class="col-xl-12 mb-2 mt-3">
                                                        <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                            <input name="product7[]" <?php echo $chproduct17 ?>
                                                                   data-checkbox-required="yes" validation-message="Please check 'Select this pricing option and apply it to the payment schedule' field."
                                                                   id="product17" value="<?php echo $row['PricePerPerson1'] ?>" type="checkbox" onclick="multiply(), totalIt7(),totalIt27(),subtrIt(),toggle17(this)" />
                                                ...
                                                <div class="col-xl-12 mt-3 mb-5">
                                                    <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                        <input name="product[]" <?php echo $chproduct1 ?>
                                                               data-checkbox-required="yes" validation-message="Please check 'By selecting this pricing option, I hereby certify that the details provided are correct' field."
                                                               id="product1" value="<?php echo $row['TotalPrice1'] ?>" type="checkbox" onclick="toggle1(this), totalIt(),totalIt2(),fmultiply()" />
                                            ...
                                            <div class="row mt-10 <?php echo $option2class ?>">
                                                ...
                                                <?php if (empty($row['FullPaymentDate'])) { ?>
                                                    ...
                                                    <div class="col-xl-12 mb-2 mt-3">
                                                        <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                            <input name="product7[]" <?php echo $chproduct27 ?>
                                                                   data-checkbox-required="yes" validation-message="Please check 'Select this pricing option and apply it to the payment schedule' field."
                                                                   id="product27" value="<?php echo $row['PricePerPerson2'] ?>" type="checkbox" onclick="multiply(), totalIt7(),totalIt27(),subtrIt(),toggle27(this)" />
                                                            <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">Select this pricing option and apply it to the payment schedule. <span class="text-danger">*</span></small></label>
                                                ...
                                                <div class="col-xl-12 mt-3 mb-5">
                                                    <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                        <input name="product[]" <?php echo $chproduct2 ?>
                                                               data-checkbox-required="yes" validation-message="Please check 'By selecting this pricing option, I hereby certify that the details provided are correct' field."
                                                               id="product2" value="<?php echo $row['TotalPrice2'] ?>" type="checkbox" onclick="toggle2(this), totalIt(),totalIt2(),fmultiply()" />
                                                        <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
                                            ...
                                            <div class="row mt-10 <?php echo $option3class ?>">
                                                ...
                                                <?php if (empty($row['FullPaymentDate'])) { ?>
                                                    ...
                                                    <div class="col-xl-12 mb-2 mt-3">
                                                        <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                            <input name="product7[]" <?php echo $chproduct37 ?>
                                                                   data-checkbox-required="yes" validation-message="Please check 'Select this pricing option and apply it to the payment schedule' field."
                                                                   id="product37" value="<?php echo $row['PricePerPerson3'] ?>" type="checkbox" onclick="multiply(), totalIt7(),totalIt27(),subtrIt(),toggle37(this)" />
                                                            <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">Select this pricing option and apply it to the payment schedule. <span class="text-danger">*</span></small></label>
                                                ...
                                                <div class="col-xl-12 mt-3 mb-5">
                                                    <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                        <input name="product[]" <?php echo $chproduct3 ?>
                                                               data-checkbox-required="yes" validation-message="Please check 'By selecting this pricing option, I hereby certify that the details provided are correct' field."
                                                               id="product3" value="<?php echo $row['TotalPrice3'] ?>" type="checkbox" onclick="toggle3(this), totalIt(),totalIt2(),fmultiply()" />
                                                        <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
                                            ...
                                            <div class="row mt-10 <?php echo $option4class ?>">
                                                ...
                                                <?php if (empty($row['FullPaymentDate'])) { ?>
                                                    ...
                                                    <div class="col-xl-12 mb-2 mt-3">
                                                        <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                            <input name="product7[]" <?php echo $chproduct47 ?>
                                                                   data-checkbox-required="yes" validation-message="Please check 'Select this pricing option and apply it to the payment schedule' field."
                                                                   id="product47" value="<?php echo $row['PricePerPerson4'] ?>" type="checkbox" onclick="multiply(), totalIt7(),totalIt27(),subtrIt(),toggle47(this)" />
                                                            <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">Select this pricing option and apply it to the payment schedule. <span class="text-danger">*</span></small></label>
                                                ...
                                                <div class="col-xl-12 mt-3 mb-5">
                                                    <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                        <input name="product[]" <?php echo $chproduct4 ?>
                                                               data-checkbox-required="yes" validation-message="Please check 'By selecting this pricing option, I hereby certify that the details provided are correct' field."
                                                               id="product4" value="<?php echo $row['TotalPrice4'] ?>" type="checkbox" onclick="toggle4(this), totalIt(),totalIt2(),fmultiply()" />
                                                        <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
                                            ...
                                            <div class="row mt-10 <?php echo $option5class ?>">
                                                ...
                                                <?php if (empty($row['FullPaymentDate'])) { ?>
                                                    ...
                                                    <div class="col-xl-12 mb-2 mt-3">
                                                        <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                            <input name="product7[]"  <?php echo $chproduct57 ?>
                                                                   data-checkbox-required="yes" validation-message="Please check 'Select this pricing option and apply it to the payment schedule' field."
                                                                   id="product57" value="<?php echo $row['PricePerPerson5'] ?>" type="checkbox" onclick="multiply(), totalIt7(),totalIt27(),subtrIt(),toggle57(this)" />
                                                            <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">Select this pricing option and apply it to the payment schedule. <span class="text-danger">*</span></small></label>
                                                ...
                                                <div class="col-xl-12 mt-3 mb-5">
                                                    <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                        <input name="product[]" <?php echo $chproduct5 ?>
                                                               data-checkbox-required="yes" validation-message="Please check 'By selecting this pricing option, I hereby certify that the details provided are correct' field."
                                                               id="product5" value="<?php echo $row['TotalPrice5'] ?>" type="checkbox" onclick="toggle5(this), totalIt(),totalIt2(),fmultiply()" />
                                                        <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
...
<?php //echo $row["CancelNoReason"] ?>
                                    ...
                                    <div class="lead card-body pb-0 pt-3">
                                        ...
                                        <?php if (!empty( $row['InsurancePersonType1'])) { ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 mt-3 mb-5">
                                                    <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                        <input type="checkbox" <?php echo $chinsurance1 ?>
                                                               data-checkbox-required="yes" validation-message="Please check 'By selecting this pricing option, I hereby certify that the details provided are correct' field."
                                                               name="product77[]" value="<?php echo $row['InsuranceTotalPrice1']; ?>"onclick="totalIt77(),toggle11(this)" />
                                                        <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
                                        ...
                                        <?php if (!empty( $row['InsurancePersonType2'])) { ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 mt-3 mb-5">
                                                    <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                        <input type="checkbox" <?php echo $chinsurance2 ?>
                                                               data-checkbox-required="yes" validation-message="Please check 'By selecting this pricing option, I hereby certify that the details provided are correct' field."
                                                               name="product77[]" value="<?php echo $row['InsuranceTotalPrice2']; ?>"onclick="totalIt77(),toggle12(this)" />
                                                        <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
                                        ...
                                        <?php if (!empty( $row['InsurancePersonType3'])) { ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 mt-3 mb-5">
                                                    <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                        <input type="checkbox" <?php echo $chinsurance3 ?>
                                                               data-checkbox-required="yes" validation-message="Please check 'By selecting this pricing option, I hereby certify that the details provided are correct' field."
                                                               name="product77[]" value="<?php echo $row['InsuranceTotalPrice3']; ?>"onclick="totalIt77(),toggle13(this)" />
                                                        <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
                                        ...
                                        <?php if (!empty( $row['InsurancePersonType4'])) { ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 mt-3 mb-5">
                                                    <label class="checkbox checkbox-outline checkbox-success checkbox-lg checkbox-outline-2x">
                                                        <input type="checkbox" <?php echo $chinsurance4 ?>
                                                               data-checkbox-required="yes" validation-message="Please check 'By selecting this pricing option, I hereby certify that the details provided are correct' field."
                                                               name="product77[]" value="<?php echo $row['InsuranceTotalPrice4']; ?>"onclick="totalIt77(),toggle14(this)" />
                                                        <span class="mr-3"></span><small class="font-size-lg text-dark font-weight-bold">By selecting this pricing option, I hereby certify that the details provided are correct. <span class="text-danger">*</span></small></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <?php if (!empty($row['InsuranceProvider'])) { ?>
                                                ...
                                                <div class="col-xl-12 mt-3">
                                                    ...
                                                    ?>
                                                    <label class="radio radio-outline radio-success radio-lg radio-outline-2x">
                                                        <input <?php echo $InsuranceAcceptedYes ?> type="radio" checked
                                                                                                   onClick="myFunction444(), insuranceagreed(), uncheckoptions1(), gp_not_wish_mandatory_field()"
                                                                                                   id="myCheck444" name="InsuranceAccepted" value="Yes">
                                                ...
                                                <div class="col-xl-12 mt-3">
                                                    <label class="radio radio-outline radio-danger radio-lg radio-outline-2x">
                                                        ...
                                                        if ($row['InsuranceAccepted'] == 'No')
                                                            ...
                                                            $InsuranceAcceptedNo = '';
                                                        ?>
                                                        <input type="radio" <?php echo $InsuranceAcceptedNo ?> name="InsuranceAccepted" id="myCheck445"
                                                               onClick="uncheckoptions2(), myFunction445(), thereason(), gp_not_wish_mandatory_field()" value="No">
                                                ...
                                                <div class="col-xl-12 mt-3 mb-5">
                                                    ...
                                                    <label class="radio radio-outline radio-danger radio-lg radio-outline-2x">
                                                        <input type="radio" <?php echo $NoPurchaseInsurance ?> name="PurchaseInsurance" id="myCheck446"
                                                               onClick="uncheckoptions3(), myFunction446(), weaver(), gp_not_wish_mandatory_field()" value="No">
                ...
                document.getElementById("sig-canvas1").style.backgroundColor = "lightyellow";*/
                                            ...
                                            <script>
                                                ...
                                                //Not used yet
                                                function isSignatureMade(canvas) {
                                                    ...
                                                    // Check if any pixel is not blank (not all are 0)
                                                    for (let i = 0; i < pixelData.length; i += 4) {
                                                        // If any pixel is not white (assuming white background: 255, 255, 255)
                                                        if (pixelData[i] !== 255 || pixelData[i + 1] !== 255 || pixelData[i + 2] !== 255 || pixelData[i + 3] !== 255) {
                                                            return true; // Signature is made
                                                        }
                                                    }

                                                    return false; // No signature made
                                                }


                                                function gp_not_wish_mandatory_field() {
                                                    setTimeout(function (){
                                                        var checkBox_agree_travel_insurance = document.getElementById("myCheck444");
                                                        var checkBox_not_agree_travel_insurance = document.getElementById("myCheck445");
                                                        var checkBox_do_not_wish_purchase = document.getElementById("myCheck446");

                                                        if (checkBox_agree_travel_insurance.checked == true){
                                                            gp_make_travel_insurance_nonmandatory();
                                                        }
                                                        if (checkBox_not_agree_travel_insurance.checked == true){
                                                            gp_make_travel_insurance_nonmandatory();
                                                        }

                                                        if (checkBox_do_not_wish_purchase.checked == true){
                                                            gp_make_travel_insurance_mandatory();
                                                        }
                                                ...
                                                function gp_make_travel_insurance_mandatory(){

                                                    const inputField = document.getElementById("InsuranceWeaverConsentName");
                                                    if (inputField) {
                                                ...
                                                function gp_make_travel_insurance_nonmandatory(){
                                                    const inputField = document.getElementById("InsuranceWeaverConsentName");
                                                    if (inputField) {
                                                ...
                                                <?php if($NoPurchaseInsurance == 'checked') { ?>
                                                gp_not_wish_mandatory_field();
                                                <?php } ?>
    ...
    <?php if(0) { ?>
        <script>
            document.getElementById("booking-authorization-clients-form").addEventListener("submit", function (event) {
                const canvas = document.getElementById("sig-canvas1");
                const signatureData = canvas.toDataURL(); // Get the canvas data as a data URL
                const blankCanvas = document.createElement("canvas");
                blankCanvas.width = canvas.width;
                blankCanvas.height = canvas.height;
                const blankData = blankCanvas.toDataURL(); // Get a blank canvas data URL
        ...
        <script>
            jQuery(document).ready(function($) {
                ...
                $('#booking-authorization-clients-form').on('submit', function(event) {
                    ...
                    // $('input[type="checkbox"][data-checkbox-required="yes"]:not(div.hidden input[type="checkbox"])').each(function () {
                    //     // If the checkbox is not checked
                    //     if (!this.checked) {
                    //         // Get the validation message
                    //         const validationMessage = $(this).attr('validation-message');
                    //
                    //         // Alert the validation message
                    //         alert(validationMessage);
                    //
