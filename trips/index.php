...
<title>Bucket List Trips | <?php echo $TagTitle ?></title>
...
<meta property="og:image" content="https://centreholidays.com/img/trips/index-h01.jpg" />
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide text-uppercase font-weight-bolder">Bucket List Trips</button></a> 
  </div>
</div>
  </div>
</div>
