...
// Start a new session
session_start();  
$highlightsoperators='Disney'; // Highlights
$operators='Disney'; // Trips
$offersoperators='Disney'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Disney | <?php echo $TagTitle ?></title>
        <meta name="description" content="From exciting theme parks to cruises to tours around the world and a resort in Hawaii, you'll discover the imagination, possibilities and magic of Disney.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-partners/disney-h01.jpg" />
<meta property="og:description" content="From exciting theme parks to cruises to tours around the world and a resort in Hawaii, you'll discover the imagination, possibilities and magic of Disney.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-partners/disney-c01.jpg" alt="Disney"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Magic Of Disney</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Disney</h1>
									<h2 class="text-dark-65 font-weight-bolder">From exciting theme parks to cruises to tours around the world and a resort in Hawaii, you'll discover the imagination, possibilities and magic of Disney.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
