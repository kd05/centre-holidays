...
// Start a new session
session_start();  
$highlightsoperators='Air Canada Vacations'; // Highlights
$operators='Air Canada Vacations'; // Trips
$offersoperators='Air Canada Vacations'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Air Canada Vacations | <?php echo $TagTitle ?></title>
        <meta name="description" content="We make every travel experience one to remember. From beaches to cityscapes to mountain tops, we’ve thought of the perfect places for every type of traveller.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-partners/air-canada-vacations-h01.jpg" />
<meta property="og:description" content="We make every travel experience one to remember. From beaches to cityscapes to mountain tops, we’ve thought of the perfect places for every type of traveller.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-partners/air-canada-vacations-c01.jpg" alt="Air Canada Vacations"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Making Your Dreams Travel</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Air Canada Vacations</h1>
									<h2 class="text-dark-65 font-weight-bolder">We make every travel experience one to remember. From beaches to cityscapes to mountain tops, we’ve thought of the perfect places for every type of traveller.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
