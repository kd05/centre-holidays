...
// Start a new session
session_start();  
$highlightsoperators='Beaches Resorts'; // Highlights
$operators='Beaches Resorts'; // Trips
$offersoperators='Beaches Resorts'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Beaches Resorts | <?php echo $TagTitle ?></title>
        <meta name="description" content="Only at Beaches Resorts can one truly experience luxury included vacations where kids and grownups alike can do as much - or as little - as they want.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-partners/beaches-resorts-h01.jpg" />
<meta property="og:description" content="Only at Beaches Resorts can one truly experience luxury included vacations where kids and grownups alike can do as much - or as little - as they want.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-partners/beaches-resorts-c01.jpg" alt="Beaches Resorts"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Resorts For Everyone</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Beaches Resorts</h1>
									<h2 class="text-dark-65 font-weight-bolder">Only at Beaches Resorts can one truly experience luxury included vacations where kids and grownups alike can do as much - or as little - as they want.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
