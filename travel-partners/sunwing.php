...
// Start a new session
session_start();  
$highlightsoperators='Sunwing'; // Highlights
$operators='Sunwing'; // Trips
$offersoperators='Sunwing'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Sunwing | <?php echo $TagTitle ?></title>
        <meta name="description" content="We're committed to providing you with award-winning service, showing you the best of what a destination has to offer and being with you every step of the way.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-partners/sunwing-h01.jpg" />
<meta property="og:description" content="We're committed to providing you with award-winning service, showing you the best of what a destination has to offer and being with you every step of the way.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-partners/sunwing-c01.jpg" alt="Sunwing"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Vacation Better</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Sunwing</h1>
									<h2 class="text-dark-65 font-weight-bolder">We're committed to providing you with award-winning service, showing you the best of what a destination has to offer and being with you every step of the way.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
