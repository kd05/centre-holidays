...
// Start a new session
session_start();  
$highlightsoperators='Rocky Mountaineer'; // Highlights
$operators='Rocky Mountaineer'; // Trips
$offersoperators='Rocky Mountaineer'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Rocky Mountaineer | <?php echo $TagTitle ?></title>
        <meta name="description" content="Rocky Mountaineer offers truly moving luxury train journeys that showcase some of the most spectacular scenery North America has to offer.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-partners/rocky-mountaineer-h01.jpg" />
<meta property="og:description" content="Rocky Mountaineer offers truly moving luxury train journeys that showcase some of the most spectacular scenery North America has to offer.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-partners/rocky-mountaineer-c01.jpg" alt="Rocky Mountaineer"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Truly Moving Train Journeys</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Rocky Mountaineer</h1>
									<h2 class="text-dark-65 font-weight-bolder">Rocky Mountaineer offers truly moving luxury train journeys that showcase some of the most spectacular scenery North America has to offer.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
