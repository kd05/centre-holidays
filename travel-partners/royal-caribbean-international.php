...
// Start a new session
session_start();  
$highlightsoperators='Royal Caribbean International'; // Highlights
$operators='Royal Caribbean International'; // Trips
$offersoperators='Royal Caribbean International'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Royal Caribbean International | <?php echo $TagTitle ?></title>
        <meta name="description" content="No vacation’s as big or as bold as a Royal Caribbean cruise. Each ship offers world class dining, dazzling entertainment and plenty of family-friendly thrills.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-partners/royal-caribbean-international-h01.jpg" />
<meta property="og:description" content="No vacation’s as big or as bold as a Royal Caribbean cruise. Each ship offers world class dining, dazzling entertainment and plenty of family-friendly thrills.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-partners/royal-caribbean-international-c01.jpg" alt="Royal Caribbean International"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Where Extraordinary Happens</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Royal Caribbean International</h1>
									<h2 class="text-dark-65 font-weight-bolder">No vacation’s as big or as bold as a Royal Caribbean cruise. Each ship offers world class dining, dazzling entertainment and plenty of family-friendly thrills.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
