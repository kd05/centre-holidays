...
// Start a new session
session_start();  
$highlightsoperators='AmaWaterways'; // Highlights
$operators='AmaWaterways'; // Trips
$offersoperators='AmaWaterways'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>AmaWaterways | <?php echo $TagTitle ?></title>
        <meta name="description" content="Step aboard a world of unparalleled experiences where your journey is our passion. When you sail with AmaWaterways, each day will bring a genuine smile.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-partners/amawaterways-h01.jpg" />
<meta property="og:description" content="Step aboard a world of unparalleled experiences where your journey is our passion. When you sail with AmaWaterways, each day will bring a genuine smile.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-partners/amawaterways-c01.jpg" alt="AmaWaterways"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Leading The Way In River Cruising</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">AmaWaterways</h1>
									<h2 class="text-dark-65 font-weight-bolder">Step aboard a world of unparalleled experiences where your journey is our passion. When you sail with AmaWaterways, each day will bring a genuine smile.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
