...
// Start a new session
session_start();  
$highlightsoperators='Sandals Resorts'; // Highlights
$operators='Sandals Resorts'; // Trips
$offersoperators='Sandals Resorts'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Sandals Resorts | <?php echo $TagTitle ?></title>
        <meta name="description" content="Sandals offers more quality inclusions than any other luxury beach resort. Experience the very pinnacle of luxury Caribbean all-inclusive vacations for couples.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-partners/sandals-resorts-h01.jpg" />
<meta property="og:description" content="Sandals offers more quality inclusions than any other luxury beach resort. Experience the very pinnacle of luxury Caribbean all-inclusive vacations for couples.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-partners/sandals-resorts-c01.jpg" alt="Sandals Resorts"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Luxury Included Vacations</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Sandals Resorts</h1>
									<h2 class="text-dark-65 font-weight-bolder">Sandals offers more quality inclusions than any other luxury beach resort. Experience the very pinnacle of luxury Caribbean all-inclusive vacations for couples.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
