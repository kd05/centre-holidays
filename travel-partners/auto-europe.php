...
// Start a new session
session_start();  
$highlightsoperators='Auto Europe'; // Highlights
$operators='Auto Europe'; // Trips
$offersoperators='Auto Europe'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Auto Europe | <?php echo $TagTitle ?></title>
        <meta name="description" content="For over 60 years, Auto Europe has been a global leader in providing car rentals, motorhome rentals and motorcycle rentals to travellers around the world.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-partners/auto-europe-h01.jpg" />
<meta property="og:description" content="For over 60 years, Auto Europe has been a global leader in providing car rentals, motorhome rentals and motorcycle rentals to travellers around the world.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-partners/auto-europe-c01.jpg" alt="Auto Europe"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Best Rental Rates Worldwide</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Auto Europe</h1>
									<h2 class="text-dark-65 font-weight-bolder">For over 60 years, Auto Europe has been a global leader in providing car rentals, motorhome rentals and motorcycle rentals to travellers around the world.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
