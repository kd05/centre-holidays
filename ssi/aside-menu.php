...
<?php if (empty($AgentID)) { ?>            
            ...
            <?php if (
                            !empty($FrontFaceBook) ||
                            !empty($FrontInstagram) ||
                            !empty($FrontTikTok) ||
                            !empty($FrontTwitter) ||
                            !empty($FrontPinterest) ||
                            !empty($FrontLinkedIn) ||
                            !empty($FrontYouTube) ||
                            !empty($FrontBlog)
                    ) { ?>
            ...
            <?php if (!empty($AgentID)) { ?>
                <?php if (!empty($FrontTikTok)) { ?>
                    <li class="menu-item" aria-haspopup="true" ><a href="<?php echo $FrontTikTok ?>" title="Follow On TikTok" target="_blank" class="menu-link"><span class="svg-icon menu-icon"><!--begin::Icon--><i class="fab fa-tiktok text-warning"></i><!--end::Icon--></span><span class="menu-text text-warning font-weight-bolder">TikTok</span></a></li>
                <?php } ?>
            <?php } ?>


            <?php if (!empty($AgentID)) { ?>
            <?php if (!empty($FrontTwitter)) { ?>
