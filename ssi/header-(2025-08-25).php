...
<?php if (!empty($AgentID)) { ?>
                          <li class="menu-item "  aria-haspopup="true"><a  href="/company/profile.php" class="menu-link" title="About <?php echo $titlename ?>"><span class="svg-icon menu-icon"><!--begin::Icon-->
...
<span class="label label-warning label-rounded label-inline"><?php echo $numbeofreviews ?></span>															</span></a></li>
...
<span class="label label-warning label-rounded label-inline"><?php echo $numawards ?></span>															</span></a></li>
<?php if (empty($AgentID)) { ?>
...
<?php } ?>
    ...
    <form enctype="multipart/form-data" action="https://<?php echo trim($_SERVER['HTTP_HOST']); ?>/search-results.php" method="get">
...
<div class="row row-paddingless">
    <!--begin:Item-->
    <div class="col-6">
        <a href="<?php echo $FrontFaceBook ?>" title="Follow On Facebook" target="_blank" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
...
<!--begin:Item-->
    <div class="col-6">
        <a href="<?php echo $FrontInstagram ?>" title="Follow On Instagram" target="_blank" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
    ...
    <!--begin:Item-->
    <div class="col-6">
        <a href="<?php echo $FrontTwitter ?>" title="Follow On Twitter" target="_blank" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
    ...
    <!--begin:Item-->
    <div class="col-6">
        <a href="<?php echo $FrontPinterest ?>" title="Follow On Pinterest" target="_blank" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
    ...
    <!--begin:Item-->
    <div class="col-6">
        <a href="<?php echo $FrontLinkedIn ?>" title="Follow On LinkedIn" target="_blank" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
...
<!--begin:Item-->
    <div class="col-6">
        <a href="<?php echo $FrontYouTube ?>" title="Follow On YouTube" target="_blank" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
...
<?php } ?>
<?php if (!empty($AgentID)) { ?>
<?php if (!empty($FrontBlog)) { ?>
<!--begin:Item-->
    <div class="col-6">
        <a href="<?php echo $FrontBlog ?>" title="Follow Via Blog" target="_blank" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
            <span><!--begin::Icon--><i class="fas fa-blog fa-3x text-warning"></i><!--end::Icon--></span>            <span class="d-block text-warning font-weight-bolder font-size-h6 mt-2 mb-1">Blog</span>
        </a>
    </div>
    <!--end:Item-->
<?php } ?>
         ...
         <!--begin::User-->
		            <div class="topbar-item">
		                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
							<span class="text-warning font-weight-bolder font-size-base d-none d-md-inline mr-2"><?php if (empty($AgentID)) { ?>1-888-823-8801<?php } ?><?php if (!empty($AgentID)) { ?><?php echo $TopNumber ?><?php } ?></span>
