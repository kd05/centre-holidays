...
// Start a new session
session_start();  
$highlightscontinent='South America And Antarctica'; //Highlights
$tcontinent='South America And Antarctica';//Trips
$offerscontinent='South America And Antarctica'; //Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>South America & Antarctica | <?php echo $TagTitle ?></title>
        <meta name="description" content="Douse yourself in the essence of exoticism of rainforests, ruins, wildlife and icebergs. South America and Antarctica sets the stage for incredible adventures.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/destinations/south-america-antarctica-h01.jpg" />
<meta property="og:description" content="Douse yourself in the essence of exoticism of rainforests, ruins, wildlife and icebergs. South America and Antarctica sets the stage for incredible adventures.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/destinations/south-america-antarctica-c01.jpg" alt="Machu Picchu, Peru"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Machu Picchu, Peru</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">South America &amp; Antarctica</h1>
									<h2 class="text-dark-65 font-weight-bolder">Douse yourself in the essence of exoticism of rainforests, ruins, wildlife and icebergs. South America and Antarctica sets the stage for incredible adventures.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
