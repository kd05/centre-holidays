...
// Start a new session
session_start();  
$highlightscontinent='Africa And Middle East'; //Highlights
$tcontinent='Africa And Middle East';//Trips
$offerscontinent='Africa And Middle East'; //Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Africa & Middle East | <?php echo $TagTitle ?></title>
        <meta name="description" content="For many, these regions are where it all began and where adventure still awaits. The terrain and wildlife provides a unique backdrop for a memorable experience.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/destinations/africa-middle-east-h01.jpg" />
<meta property="og:description" content="For many, these regions are where it all began and where adventure still awaits. The terrain and wildlife provides a unique backdrop for a memorable experience.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/destinations/africa-middle-east-c01.jpg" alt="Lions In The Serengeti, Tanzania"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Lions In The Serengeti, Tanzania</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row pl-10 pr-10 justify-content-center">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Africa & Middle East</h1>
									<h2 class="text-dark-65 font-weight-bolder">For many, these regions are where it all began and where adventure still awaits. The terrain and wildlife provides a unique backdrop for a memorable experience.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
...
<li class="nav-item">
<a class="nav-link active font-weight-bolder text-uppercase font-size-lg text-dark" data-toggle="tab" href="#highlights-tab">Highlights (<?php echo $highlitscount ?>)</a>
</li>
<?php } if ($tripscount !=0) { ?>
<li class="nav-item">
