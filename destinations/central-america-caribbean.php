...
// Start a new session
session_start();  
$highlightscontinent='Central America And Caribbean'; //Highlights
$tcontinent='Central America And Caribbean';//Trips
$offerscontinent='Central America And Caribbean'; //Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Central America & Caribbean | <?php echo $TagTitle ?></title>
        <meta name="description" content="Breathtaking places, beautiful sights, delicious cuisines, pulsating music and hospitable people, Central America and the Caribbean caters to everyone.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/destinations/central-america-caribbean-h01.jpg" />
<meta property="og:description" content="Breathtaking places, beautiful sights, delicious cuisines, pulsating music and hospitable people, Central America and the Caribbean caters to everyone.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/destinations/central-america-caribbean-c01.jpg" alt="Jade Mountain, St. Lucia"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Jade Mountain, St. Lucia</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Central America &amp; Caribbean</h1>
									<h2 class="text-dark-65 font-weight-bolder">Breathtaking places, beautiful sights, delicious cuisines, pulsating music and hospitable people, Central America and the Caribbean caters to everyone.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
