...
// Start a new session
session_start();  
$highlightscontinent='UK And Europe'; //Highlights
$tcontinent='UK And Europe';//Trips
$offerscontinent='UK And Europe'; //Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>UK & Europe | <?php echo $TagTitle ?></title>
        <meta name="description" content="For the curious at heart looking for a rich cultural experience, the cities of the UK and Europe are the perfect destinations for art, food, music and history.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/destinations/uk-europe-h01.jpg" />
<meta property="og:description" content="For the curious at heart looking for a rich cultural experience, the cities of the UK and Europe are the perfect destinations for art, food, music and history.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/destinations/uk-europe-c01.jpg" alt="Cotswolds, England"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Cotswolds, England</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">UK &amp; Europe</h1>
									<h2 class="text-dark-65 font-weight-bolder">For the curious at heart looking for a rich cultural experience, the cities of the UK and Europe are the perfect destinations for art, food, music and history.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
