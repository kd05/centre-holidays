...
// Start a new session
session_start();  
$highlightscontinent='North America'; //Highlights
$tcontinent='North America';//Trips
$offerscontinent='North America'; //Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>North America | <?php echo $TagTitle ?></title>
