...
if (($_POST['FeedFName'] != $_POST['FeedLName']) && !empty($_POST['FeedFName']) && !empty($_POST['FeedLName'])) {

$flname=$_POST['FeedFName'].' '.$_POST['FeedLName'];	
//include($_SERVER['DOCUMENT_ROOT'].'/library/ipinfo.php');


//    echo "1) new ===>"; echo "<pre>"; print_r($_POST); echo "</pre>";  echo "1) end.. ===>";exit;
        ...
        <div class="card card-custom card-border card-stretch">
            ...
            <div class="card-body d-flex flex-column" id="thisform">
                ...
                <form id='userForm' action="" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                    <input type="hidden" id="FeedLocation" name="FeedLocation"
                           value="<?php echo $City . ', ' . strtoupper(substr($Region, 0, 2)) ?>"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg"
                                       value="<?php echo $_SESSION['FeedFName'] ?>" placeholder="First Name"
                                       name="FeedFName" id="FeedFName" required>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg"
                                       value="<?php echo $_SESSION['FeedLName'] ?>" placeholder="Last Name" name="FeedLName"
                                       id="FeedLName" required>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="form-group">
                                <label>Phone</label>
                                <input type="text" class="form-control form-control-lg"
                                       value="<?php echo $_SESSION['Phone'] ?>" placeholder="Phone" name="FeedPhone"
                                       id="FeedPhone">
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control form-control-lg"
                                       value="<?php echo $_SESSION['FeedEmail'] ?>" placeholder="Email" name="FeedEmail"
                                       id="FeedEmail" required>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="form-group">
                                <label>Travel Advisor / Agency</label>
                                <input type="email" class="form-control form-control-lg bg-light" placeholder=""
                                       name="Agency" id="Agency" value="<?php echo $agentname ?>" required readonly>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="form-group">
                                ...
                                <div class="star-rating">
                                    <fieldset>
                                        ...
                                        <input type="radio" id="star4" name="FeedExperience" value="4"/><label for="star4"
                                                                                                               title="">4
                                            stars</label>
                                        <input type="radio" id="star3" name="FeedExperience" value="3"/><label for="star3"
                                                                                                               title="">3
                                            stars</label>
                                        <input type="radio" id="star2" name="FeedExperience" value="2"/><label for="star2"
                                                                                                               title="">2
                                            stars</label>
                                        <input type="radio" id="star1" name="FeedExperience" value="1"/><label for="star1"
                                                                                                               title="">1
                                            star</label>
                                    </fieldset>
                                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg"
                                       value="<?php echo $_SESSION['FeedTitle'] ?>" placeholder="*Title" name="FeedTitle"
                                       id="FeedTitle" required>
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="form-group">
                                <label>Write Your Review <span class="text-danger">*</span></label>
                                <textarea class="form-control form-control-lg" id="FeedMessage" name="FeedMessage" rows="5"
                                          placeholder="Write Your Review"
                                          required><?php echo $_SESSION['FeedMessage'] ?></textarea>
                            </div>
                        </div>
<!--                        <div class="col-xl-3">-->
<!--                            <div class="form-group">-->
...
<!--                                <input class="form-control form-control-lg" type="text" value="" id="question"-->
<!--                                       name="question" placeholder="Answer"/>-->
<!--                            </div>-->
<!--                        </div>-->
                    </div>
...
<!--                        <script src="https://www.google.com/recaptcha/api.js" async defer></script>-->
                        ...
                        <input type="submit"
                               class="g-recaptcha btn btn-lg btn-warning text-uppercase font-weight-bolder px-7 py-5"
                               value="Submit Review" name="post" id="post"
                               data-sitekey="6LddJc8ZAAAAAMd-S9vjpAm-Ycj1G7_jodCR-zmq" data-callback='onSubmit'>
