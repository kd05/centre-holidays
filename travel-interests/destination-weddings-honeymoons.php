...
// Start a new session
session_start();  
$highlightsinterests='Weddings And Honeymoons'; // Highlights
$interests='Weddings And Honeymoons'; // Trips
$offersinterests='Weddings And Honeymoons'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Destination Weddings & Honeymoons | <?php echo $TagTitle ?></title>
        <meta name="description" content="Celebrate the perfect day in paradise with family and friends. Continue the celebration with a stress-free, sensual getaway where the choices are endless.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/destination-weddings-honeymoons-h01.jpg" />
<meta property="og:description" content="Celebrate the perfect day in paradise with family and friends. Continue the celebration with a stress-free, sensual getaway where the choices are endless.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/destination-weddings-honeymoons-c01.jpg" alt="Beach Wedding, Caribbean"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Beach Wedding, Caribbean</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Weddings &amp; Honeymoons</h1>
									<h2 class="text-dark-65 font-weight-bolder">Celebrate the perfect day in paradise with family and friends. Continue the celebration with a stress-free, sensual getaway where the choices are endless.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
