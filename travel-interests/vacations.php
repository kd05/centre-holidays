...
// Start a new session
session_start();  
$highlightsinterests='Vacations'; // Highlights
$interests='Vacations'; // Trips
$offersinterests='Vacations'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Vacations | <?php echo $TagTitle ?></title>
        <meta name="description" content="Sunny destinations bring out the colour in everything. Adventure awaits with an array of travel options for families, couples, groups or solo travellers.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/vacations-h01.jpg" />
<meta property="og:description" content="Sunny destinations bring out the colour in everything. Adventure awaits with an array of travel options for families, couples, groups or solo travellers.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/vacations-c01.jpg" alt="Bacardi Island, Dominican Republic"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Bacardi Island, Dominican Republic</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Vacations</h1>
									<h2 class="text-dark-65 font-weight-bolder">Sunny destinations bring out the colour in everything. Adventure awaits with an array of travel options for families, couples, groups or solo travellers.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
