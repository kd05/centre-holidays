...
// Start a new session
session_start();  
$highlightsinterests='Tailor Made Travel'; // Highlights
$interests='Tailor Made Travel'; // Trips
$offersinterests='Tailor Made Travel'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Tailor Made Travel | <?php echo $TagTitle ?></title>
        <meta name="description" content="See the world the way you want to see it with a tailor made trip. Based on your needs, we will design and refine your itinerary until you are pleased.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/tailor-made-travel-h01.jpg" />
<meta property="og:description" content="See the world the way you want to see it with a tailor made trip. Based on your needs, we will design and refine your itinerary until you are pleased.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/tailor-made-travel-c01.jpg" alt="Balloons Over Bagan, Myanmar"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Balloons Over Bagan, Myanmar</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row pl-10 pr-10 justify-content-center">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Tailor Made Travel</h1>
									<h2 class="text-dark-65 font-weight-bolder">See the world the way you want to see it with a tailor made trip. Based on your needs, we will design and refine your itinerary until you are pleased.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
...
<li class="nav-item">
<a class="nav-link font-weight-bolder font-size-lg text-dark text-uppercase active" data-toggle="tab" href="#highlights-tab">Highlights (<?php echo $highlitscount ?>)</a>
</li>
<?php } if ($tripscount !=0) { ?>
<li class="nav-item">
