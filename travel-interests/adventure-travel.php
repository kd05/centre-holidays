...
// Start a new session
session_start();  
$highlightsinterests='Adventure Travel'; // Highlights
$interests='Adventure Travel'; // Trips
$offersinterests='Adventure Travel'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Adventure Travel | <?php echo $TagTitle ?></title>
        <meta name="description" content="A whole other world awaits for those with an active and open mind looking for adrenaline-filled trips, off-the-beaten-path adventures and fun-filled activities.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/adventure-travel-h01.jpg" />
<meta property="og:description" content="A whole other world awaits for those with an active and open mind looking for adrenaline-filled trips, off-the-beaten-path adventures and fun-filled activities.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/adventure-travel-c01.jpg" alt="Scuba Diving In A Cenote, Mexico"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Scuba Diving In A Cenote, Mexico</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Adventure Travel</h1>
									<h2 class="text-dark-65 font-weight-bolder">A whole other world awaits for those with an active and open mind looking for adrenaline-filled trips, off-the-beaten-path adventures and fun-filled activities.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
