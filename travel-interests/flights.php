...
// Start a new session
session_start();  
$highlightsinterests='Flights'; // Highlights
$interests='Flights'; // Trips
$offersinterests='Flights'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Flights | <?php echo $TagTitle ?></title>
        <meta name="description" content="Whether you choose to visit New York, the city that never sleeps, discover life down under in Australia or go island hopping in Greece, we can get you there.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/flights-h01.jpg" />
<meta property="og:description" content="Whether you choose to visit New York, the city that never sleeps, discover life down under in Australia or go island hopping in Greece, we can get you there.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/flights-c01.jpg" alt="Manhattan, New York"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Manhattan, New York</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Flights</h1>
									<h2 class="text-dark-65 font-weight-bolder">Whether you choose to visit New York, the city that never sleeps, discover life down under in Australia or go island hopping in Greece, we can get you there.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
