...
// Start a new session
session_start();  
$highlightsinterests='Sports Travel'; // Highlights
$interests='Sports Travel'; // Trips
$offersinterests='Sports Travel'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Sports Travel | <?php echo $TagTitle ?></title>
        <meta name="description" content="Create life long memories with bucket list trips that bring together two of our most desired pursuits, our love of travel combined with our passion for sport.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/sports-travel-h01.jpg" />
<meta property="og:description" content="Create life long memories with bucket list trips that bring together two of our most desired pursuits, our love of travel combined with our passion for sport.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/sports-travel-c01.jpg" alt="Luxury Sports Travel Packages"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Luxury Sports Travel Packages</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Sports Travel</h1>
									<h2 class="text-dark-65 font-weight-bolder">Create life long memories with bucket list trips that bring together two of our most desired pursuits, our love of travel combined with our passion for sport.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
