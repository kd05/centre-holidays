...
// Start a new session
session_start();  
$highlightsinterests='Cruises'; // Highlights
$interests='Cruises'; // Trips
$offersinterests='Cruises'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Cruises | <?php echo $TagTitle ?></title>
        <meta name="description" content="No matter what type of cruiser you are, you're sure to have a great time onboard while experiencing something inclusive, intimate, unique and remarkable.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/cruises-h01.jpg" />
<meta property="og:description" content="No matter what type of cruiser you are, you're sure to have a great time onboard while experiencing something inclusive, intimate, unique and remarkable.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/cruises-c01.jpg" alt="Cruising The Adriatic Sea"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide text-uppercase font-weight-bolder">Cruising The Adriatic Sea</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-dark display-3 text-uppercase">Cruises</h1>
									<h2 class="text-dark-65 font-weight-bolder">No matter what type of cruiser you are, you're sure to have a great time onboard while experiencing something inclusive, intimate, unique and remarkable.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
