...
// Start a new session
session_start();  
$highlightsinterests='Safari And Wildlife'; // Highlights
$interests='Safari And Wildlife'; // Trips
$offersinterests='Safari And Wildlife'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Safari & Wildlife | <?php echo $TagTitle ?></title>
        <meta name="description" content="Take a trip on the wild side in national parks or rainforests for a chance to encounter some of the world's most incredible wildlife in their natural habitats.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/safari-wildlife-h01.jpg" />
<meta property="og:description" content="Take a trip on the wild side in national parks or rainforests for a chance to encounter some of the world's most incredible wildlife in their natural habitats.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/safari-wildlife-c01.jpg" alt="Trekking With Gorillas, Rwanda"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Trekking With Gorillas, Rwanda</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Safari &amp; Wildlife</h1>
									<h2 class="text-dark-65 font-weight-bolder">Take a trip on the wild side in national parks or rainforests for a chance to encounter some of the world's most incredible wildlife in their natural habitats.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
