...
// Start a new session
session_start();  
$highlightsinterests='Accessible Travel'; // Highlights
$interests='Accessible Travel'; // Trips
$offersinterests='Accessible Travel'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Accessible Travel | <?php echo $TagTitle ?></title>
        <meta name="description" content="Having a disability should not stop you from travelling and seeing the world. We're here to help ensure your needs are met and that your trip is worry-free.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/accessible-travel-h01.jpg" />
<meta property="og:description" content="Having a disability should not stop you from travelling and seeing the world. We're here to help ensure your needs are met and that your trip is worry-free.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/accessible-travel-c01.jpg" alt="Accessible Travel"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide text-uppercase font-weight-bolder">Accessible Travel</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Accessible Travel</h1>
									<h2 class="text-dark-65 font-weight-bolder">Having a disability should not stop you from travelling and seeing the world. We're here to help ensure your needs are met and that your trip is worry-free.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
