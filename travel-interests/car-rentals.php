...
// Start a new session
session_start();  
$highlightsinterests='Car Rentals'; // Highlights
$interests='Car Rentals'; // Trips
$offersinterests='Car Rentals'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Car Rentals | <?php echo $TagTitle ?></title>
        <meta name="description" content="Touring by car is one of the most fulfilling methods to explore a destination. Whether you need a passenger van or a dream luxury car, we've got you covered.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/car-rentals-h01.jpg" />
<meta property="og:description" content="Touring by car is one of the most fulfilling methods to explore a destination. Whether you need a passenger van or a dream luxury car, we've got you covered.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/car-rentals-c01.jpg" alt="Aurlandsfjellet, Norway"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Aurlandsfjellet, Norway</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Car Rentals</h1>
									<h2 class="text-dark-65 font-weight-bolder">Touring by car is one of the most fulfilling methods to explore a destination. Whether you need a passenger van or a dream luxury car, we've got you covered.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
