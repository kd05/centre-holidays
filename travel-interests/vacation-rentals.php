...
// Start a new session
session_start();  
$highlightsinterests='Vacation Rentals'; // Highlights
$interests='Vacation Rentals'; // Trips
$offersinterests='Vacation Rentals'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Vacation Rentals | <?php echo $TagTitle ?></title>
        <meta name="description" content="From holiday homes in the heart of the action to private havens in far-away places, you’ll be spoilt for choice with over 4,000 properties around the world.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/vacation-rentals-h01.jpg" />
<meta property="og:description" content="From holiday homes in the heart of the action to private havens in far-away places, you’ll be spoilt for choice with over 4,000 properties around the world.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/vacation-rentals-c01.jpg" alt="Private Villa"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Private Villa</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Vacation Rentals</h1>
									<h2 class="text-dark-65 font-weight-bolder">From holiday homes in the heart of the action to private havens in far-away places, you’ll be spoilt for choice with over 4,000 properties around the world.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
