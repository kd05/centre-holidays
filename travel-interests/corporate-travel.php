...
// Start a new session
session_start();  
$highlightsinterests='Corporate Travel'; // Highlights
$interests='Corporate Travel'; // Trips
$offersinterests='Corporate Travel'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Corporate Travel | <?php echo $TagTitle ?></title>
        <meta name="description" content="Through our extended network of partners, we offer corporations of all sizes personalized service, tailored business solutions and better travel experiences.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/corporate-travel-h01.jpg" />
<meta property="og:description" content="Through our extended network of partners, we offer corporations of all sizes personalized service, tailored business solutions and better travel experiences.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/corporate-travel-c01.jpg" alt="Corporate Event"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Corporate Event</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Corporate Travel</h1>
									<h2 class="text-dark-65 font-weight-bolder">Through our extended network of partners, we offer corporations of all sizes personalized service, tailored business solutions and better travel experiences.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
