...
// Start a new session
session_start();  
$highlightsinterests='Luxury Travel'; // Highlights
$interests='Luxury Travel'; // Trips
$offersinterests='Luxury Travel'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Luxury Travel | <?php echo $TagTitle ?></title>
        <meta name="description" content="Are you looking to indulge on your upcoming trip? Experience the best in service, location and amenities in beautiful destinations and elegant properties.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/luxury-travel-h01.jpg" />
<meta property="og:description" content="Are you looking to indulge on your upcoming trip? Experience the best in service, location and amenities in beautiful destinations and elegant properties.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/luxury-travel-c01.jpg" alt="Constance Belle Mare Plage, Mauritius"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Constance Belle Mare Plage, Mauritius</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Luxury Travel</h1>
									<h2 class="text-dark-65 font-weight-bolder">Are you looking to indulge on your upcoming trip? Experience the best in service, location and amenities in beautiful destinations and elegant properties.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
