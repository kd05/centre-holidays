...
// Start a new session
session_start();  
$highlightsinterests='Train Journeys'; // Highlights
$interests='Train Journeys'; // Trips
$offersinterests='Train Journeys'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Train Journeys | <?php echo $TagTitle ?></title>
        <meta name="description" content="Travelling by train allows you to experience a country intimately. You can leisurely watch the countryside slip by, all from the comfort of your seat.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/train-journeys-h01.jpg" />
<meta property="og:description" content="Travelling by train allows you to experience a country intimately. You can leisurely watch the countryside slip by, all from the comfort of your seat.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/train-journeys-c01.jpg" alt="Onboard Rocky Mountaineer"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Onboard Rocky Mountaineer</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Train Journeys</h1>
									<h2 class="text-dark-65 font-weight-bolder">Travelling by train allows you to experience a country intimately. You can leisurely watch the countryside slip by, all from the comfort of your seat.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
