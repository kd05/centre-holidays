...
// Start a new session
session_start();  
$highlightsinterests='Hotels'; // Highlights
$interests='Hotels'; // Trips
$offersinterests='Hotels'; // Offers
?>
<!DOCTYPE html>
<html lang="en" >
    <!--begin::Head-->
...
<title>Hotels | <?php echo $TagTitle ?></title>
        <meta name="description" content="The right hotel can make your stay memorable. Whether for business or pleasure, look for a hotel that offers quality accommodations and amazing service.">
        <!-- begin:: Facebook Sharing -->
<meta property="og:image" content="https://centreholidays.com/img/travel-interests/hotels-h01.jpg" />
<meta property="og:description" content="The right hotel can make your stay memorable. Whether for business or pleasure, look for a hotel that offers quality accommodations and amazing service.">
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/travel-interests/hotels-c01.jpg" alt="The Connaught Hotel In London, UK"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">The Connaught Hotel In London, UK</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Hotels</h1>
									<h2 class="text-dark-65 font-weight-bolder">The right hotel can make your stay memorable. Whether for business or pleasure, look for a hotel that offers quality accommodations and amazing service.</h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
