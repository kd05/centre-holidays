			...
			<div class="py-10 py-lg-20">
				...
				<div class="container">
					...
					<div class="text-center mb-12">
						<!--begin::Title-->
						<h3 class="fs-2hx text-dark mb-5" id="team" data-kt-scroll-offset="{default: 100, lg: 150}">15 Amazing Team Members</h3>
						<!--end::Title-->
						<!--begin::Sub-title-->
...
<!--begin::Item-->
							...
							<div class="text-center">
								<!--begin::Photo-->
								<div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('/img/agents/307/profile.jpg')"></div>
								<!--end::Photo-->
								<!--begin::Person-->
								<div class="mb-0">
									<!--begin::Name-->
									<a href="#" title="Ami Jagger, Home Based Travel Agent" class="text-dark fw-bolder text-hover-dark fs-3" data-bs-toggle="modal" data-bs-target="#about-ch-modal">Ami Jagger</a>
									<!--end::Name-->
									<!--begin::Position-->
								  <div class="text-muted fs-6 fw-bold mt-1">Community Pod Leader</div>
									<!--begin::Position-->
								</div>
								<!--end::Person-->
							</div>
							...
							<div class="text-center">
								<!--begin::Photo-->
								<div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('/img/agents/390/profile.jpg')"></div>
								<!--end::Photo-->
								<!--begin::Person-->
								<div class="mb-0">
									<!--begin::Name-->
									<a href="#" title="Anna Aitchison, Home Based Travel Agent" class="text-dark fw-bolder text-hover-dark fs-3" data-bs-toggle="modal" data-bs-target="#about-ch-modal">Anna Aitchison</a>
									<!--end::Name-->
									<!--begin::Position-->
								  <div class="text-muted fs-6 fw-bold mt-1">Community Pod Leader</div>
									<!--begin::Position-->
							...
							<div class="text-center">
								<!--begin::Photo-->
								<div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('/img/agents/721/profile.jpg')"></div>
								<!--end::Photo-->
								<!--begin::Person-->
								<div class="mb-0">
									<!--begin::Name-->
									<a href="#" title="Patrick Monette, Home Based Travel Agent" class="text-dark fw-bolder text-hover-dark fs-3" data-bs-toggle="modal" data-bs-target="#about-ch-modal">Patrick Monette</a>
									<!--end::Name-->
									<!--begin::Position-->
								  <div class="text-muted fs-6 fw-bold mt-1">Community Pod Leader</div>
									<!--begin::Position-->
							...
							<div class="text-center">
								<!--begin::Photo-->
								<div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('/img/agents/275/profile.jpg')"></div>
								<!--end::Photo-->
								<!--begin::Person-->
								<div class="mb-0">
									<!--begin::Name-->
									<a href="#" title="Sabrina Mantel, Home Based Travel Agent" class="text-dark fw-bolder text-hover-dark fs-3" data-bs-toggle="modal" data-bs-target="#about-ch-modal">Sabrina Mantel</a>
									<!--end::Name-->
									<!--begin::Position-->
								  <div class="text-muted fs-6 fw-bold mt-1">Community Pod Leader</div>
									<!--begin::Position-->
...
<span class="fw-bolder fs-5 text-gray-800 text-start pe-3"><span class="mb-2 text-dark">$</span><b class="fs-1">1295</b> Setup Fee</span> 
</div>
<!--end::Item-->
<!--begin::Item-->
...
<!--begin::Item-->
<div class="d-flex flex-stack mb-5">
<span class="fw-bolder fs-5 text-gray-800 text-start pe-3"><span class="mb-2 text-gray-800">$</span><b class="fs-1">1295</b> Setup Fee</span> 
</div>
<!--end::Item-->
<!--begin::Item-->
<div class="d-flex flex-stack mb-10">
...
<li><b>Ami Jagger</b>, Community Pod Leader</li>
<li><b>Anna Aitchison</b>, Community Pod Leader</li>
<li><b>Sabrina Mantel</b>, Community Pod Leader</li>
<li><b>Patrick Monette</b>, Community Pod Leader</li>
</ul>
...
<br>
<br>
A special thank you to my wife Jillian of 42 years but a friend for 48 years.
<br>
<br>
...
<!--begin::Form-->
    <form id="userForm" class="form" action="email/insert-home-based-travel-agent-application-TEST.php" method="post">
        <!--begin::Row-->
        <div class="row">
            <!--begin::Input group-->
            <div class="col-md-3">
