...
//=========================================DATABASE============================
        ...
        header('Location: ../home-based-travel-agent-canada.php?results=1');
    ...
    //Captcha success fail.
        ...
        header('Location: ../home-based-travel-agent-canada.php?results=0&msg=Captcha Failed.');

    }


} else {
    header('Location: ../home-based-travel-agent-canada.php?results=0&msg=Something went wrong.');
}
