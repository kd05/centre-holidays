...
<div id="home-carousel" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  <div class="carousel-inner">	  
      ...
      <a href="/agents/supplier-details.php?afid=177" title="Riverside Cruises">
        <div class="img"><img src="/img/agents/home-c01-riverside-cruises.jpg" alt="Riverside Cruises" class="d-block w-100" border="0"></div>
  </a>
</div>    
    <div class="carousel-item">
      <a href="/agents/supplier-details.php?afid=176" title="SNAP">
        <div class="img"><img src="/img/agents/home-c02-snap.jpg" alt="SNAP" class="d-block w-100" border="0"></div>
  </a>
</div>
	  <div class="carousel-item">
      <a href="/agents/supplier-details.php?afid=172" title="Porter Airlines">
        <div class="img"><img src="/img/agents/home-c03-porter-airlines.jpg" alt="Porter Airlines" class="d-block w-100" border="0"></div>
  </a>
</div>
  </div>
...
<li class="nav-item">
<a class="nav-link active font-weight-bolder font-size-lg text-dark text-uppercase" data-toggle="tab" href="#ich-tab">Resources</a>
</li>
</ul>
<div class="tab-content mt-10">
<div class="tab-pane fade active show" id="ich-tab" role="tabpanel" aria-labelledby="ich-tab">
<?php include($_SERVER['DOCUMENT_ROOT'].'/agents/ssi/resources.php');?>
  </div>
</div>
</div> 
