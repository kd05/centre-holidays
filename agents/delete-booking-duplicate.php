...
//=======================empty the server folder=====================================

$path='../img/agents/booking-authorization-email-form/';
//unlink("../img/agents/booking-authorization-email-form/PrimePassport__1948006559589_35393422469.png");

$sql22 = "SELECT * FROM booking_1, booking_2 WHERE booking_1.BookID='".$BookID."' AND booking_1.BookID=booking_2.BookID2 LIMIT 1";
