...
<html lang="en" >
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Kwik Print - Agent Portal | Centre Holidays</title>
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
  ...
  <div class="img"><img class="d-block w-100" src="/img/agents/kwik-print-c01.jpg" alt="Kwik Print"></div>
  <div class="carousel-caption d-none d-md-block">
      <a href="#">
      <button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase">Genuine Premium Quality</button></a> 
  </div>
</div>
  </div>
</div>
    ...
    <div class=" container ">
        ...
        <div class="row pl-10 pr-10 justify-content-center">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3">Kwik Print</h1>
									<h2 class="text-dark-65 font-weight-bolder">Quality Printing. Affordable Pricing.</h2>				
            </div>              
                                    </div>
          <!--end::title-->
          </div>
...
<p>Kwik Print deals with some of the best suppliers in the print industry. We ensure that they meet the quality we are looking for so that you can come across as a professional business. At the end of the day, when your clients receive something from you, the look and feel of the product can be the deciding factor of whether or not they are going to deal with you.<br>
<br>
On this page, you will find a host of products that we can design and print. To place an order or to inquire about a product that you do not see listed, please email <b>info@kwikprint.ca</b>.</p>
            </div>
...
<!--begin::Item-->
    ...
    <!--begin::Body-->
<a href="#" title="Graphic Design" data-toggle="modal" data-target="#graphic-design-modal" class="text-white flex-grow-1">													<div class="card-body custom-overlay d-flex flex-center text-center text-hover-warning text-white text-capitalize">	
<div>								<h2 class="font-weight-boldest text-uppercase">Graphic Design</h2>
<h6>Creating Visual Content</h6>
</div>										
</div>
</a>
<!--end::Body-->
...
<!--end::Item-->
<!--begin::Modal-->
<div class="modal fade" id="graphic-design-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content border border-4">
            <div class="modal-header bg-light">
                <h2 class="font-weight-boldest text-uppercase mb-0 text-dark">Graphic Design</h2>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            ...
            <div class="modal-body lead text-dark pb-3">
<p>Kwik Print offers FREE* graphic design as long as it pertains to your travel business. This portion of the job is sometimes what costs the most as other companies may charge anywhere from $50 to $100 and above per hour.<br>
<br>
*Custom logo designs are excluded.</p>
            </div>
            <div class="modal-footer bg-light">
<button type="button" class="btn btn-warning font-weight-bolder px-5 py-3 text-uppercase" data-dismiss="modal">Close</button>
            </div>
...
<li class="nav-item">
<a class="nav-link active font-weight-bolder text-uppercase font-size-lg text-dark" data-toggle="tab" href="#representatives-tab">Representatives</a>
</li>
</ul>
<div class="tab-content mt-10" id="contact-content">
<div class="tab-pane fade active show" id="representatives-tab" role="tabpanel" aria-labelledby="representatives-tab">
...
<tbody>
<tr>
  <td class="align-middle">Dustin Shaw</td>
  <td class="align-middle">1-888-823-8801 x 100</td>
  <td rowspan="2" class="align-middle"> info@kwikprint.ca</td>
  </tr>
<tr>
  <td class="align-middle">Andre Montaut</td>
  <td class="align-middle">1-888-823-8801 x 105</td>
  </tr>
</tbody>
</table>
</div>
...
<!--begin::KP Products-->
<div id="kp-prouct-list">
<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-3x justify-content-center">
<li class="nav-item">
<a class="nav-link active font-weight-bolder text-uppercase font-size-lg text-dark" data-toggle="tab" href="#kp-prouducts-tab">Kwik Print Products</a>
</li>
</ul>
<div class="tab-content mt-10">
<div class="tab-pane fade active show" id="kp-products-tab" role="tabpanel" aria-labelledby="kp-products-tab">
<?php include($_SERVER['DOCUMENT_ROOT'].'/agents/ssi/kwik-print-products.php');?>
  </div>
</div>
</div> 
<!--end::KP Products-->
