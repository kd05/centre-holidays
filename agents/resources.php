...
<!--begin::Aside-->
<?php include($_SERVER['DOCUMENT_ROOT'].'/agents/ssi/aside-resources.php');?>
<!--end::Aside-->
			<!--begin::Wrapper-->
...
<!--begin::Form-->
<form class="d-flex position-relative w-75 px-lg-40 m-auto" action="<?php echo $_SERVER['PHP_SELF'] ?>#resources-list" method="get" enctype="multipart/form-data">
