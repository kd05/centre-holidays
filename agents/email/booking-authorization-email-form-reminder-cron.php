...
$sql = "SELECT * FROM booking_1 WHERE FormCancelled='' AND agentcron=0 AND FormApproved='' AND BookingTime > $ptime AND (BookingStatus=3 || BookingStatus=4) ORDER BY BookID DESC";
...
$urllink='https://centreholidays.com/agents/booking-authorization-email-form-preview.php?BookID='.$BookID.'&allow=no&agentcron=0';
