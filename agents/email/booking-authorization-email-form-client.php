...
<title>Booking Authorization Email Form - Client | Centre Holidays</title>
</head>
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  ...
  <tr>
    <td style="background:#001431; padding:12px; color:#fff; text-align:center; font-size: 18px;"><strong>Booking Authorization Email Form</strong></td>
  </tr>
  </tbody>
</table>
...
<b>_BusinessName_</b><br />
_BusinessFullName_<br />
_BusinessPhone_<br />
_BusinessEmail_</p>
      <center>
        <a href="_urllink_" style="display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-size: 15px; color: #fff; background: #c69a50; border-radius: 0.42rem; text-decoration:none;" title="Go" target="_blank">See Booking Authorization Email Form</a>
      </center></td>
  </tr>
  </tbody>
  </table>
