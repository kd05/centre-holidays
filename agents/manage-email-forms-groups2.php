...
<div class="col-xl-4 col-md-6 manage-results">
  ...
  <a href="booking-authorization-email-form-preview.php?BookID=<?php echo $AssignedBookID ?>&agentcron=0&allow=no&bq=620eb122403771645130018&outh=P8ez7FHxJcy0hwMnd9HEv8CgWM29x&mastpass=6696894130c2d6062d1b&agid=<?php echo $AgentID?>" target="_new" class="btn btn-lg btn-clean btn-icon mr-2" title="Preview">	                            
  <span>	                                
  <i class="fas fa-eye text-warning"></i>                           
  </span>	
  </a>  	
  <?php } else { ?>
  <a href="booking-authorization-email-form-preview.php?BookID=<?php echo $AssignedBookID ?>&allow=no&agentcron=0" target="_new" class="btn btn-lg btn-clean btn-icon mr-2" title="Preview">	                            
  <span>	                                
  <i class="fas fa-eye text-warning"></i>                           
  </span>	
  </a>  	
