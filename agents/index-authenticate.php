...
WHERE 
      ch_agents_2.BusinessEmail = '$BusinessEmail' AND 
      ch_agents_1.PasswordHashed = '$LogPassword' AND 
      ch_agents_1.active=1 AND 
      ch_agents_2.AgentID=ch_agents_1.AgentID";
...
if($row_cnt==1){
	...
	//=================================================================	
			...
			$sql5432="INSERT INTO ch_agents_log_in (agentlogid, agentlogip, country_name, agentlogdate, AgentUniqID, BusinessEmail, FirstName, LastName, code) 
                VALUES ('', '$IP', '$country_name', '$today', '$AgentID', '$BusinessEmail', '$FirstName', '$LastName', '$code')";
