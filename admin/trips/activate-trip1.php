...
//===================================recall all the current needed styles, substyles etc...========
	...
	echo $website.$departuregateways; 
	echo "<hr />";
...
//=============================================Styles=========================================================
		...
		$sql12 .= " stylestrips='0', stylestrips2='1' ";										
			elseif ($website == 2) // centre only
		$sql12 .= " stylestrips='1', stylestrips2='0' ";													
...
//=============================================Sub-Styles=========================================================
		$sql122 = "UPDATE substyles SET ";
			...
			if ($website == 1)// epike only
		$sql122 .= " substylestrips='0', substylestrips2='1' ";										
			elseif ($website == 2) // centre only
		$sql122 .= " substylestrips='1', substylestrips2='0' ";													
			elseif ($website == 3) // epike and centre
...
//=============================================Continent=========================================================
		$sql1222 = "UPDATE continent SET ";
			...
			if ($website == 1)// epike only
		$sql1222  .= " continenttrips='0', continenttrips2='1' ";										
			elseif ($website == 2) // centre only
		$sql1222  .= " continenttrips='0', continenttrips2='0' ";											
			elseif ($website == 3) // epike and centre
...
//=============================================Countries=========================================================
		$sql12222 = "UPDATE countries SET ";
			...
			if ($website == 1)// epike only
		$sql12222  .= " countriestrips='0', countriestrips2='1' ";										
			elseif ($website == 2) // centre only
		$sql12222  .= " countriestrips='1', countriestrips2='0' ";											
			elseif ($website == 3) // epike and centre
...
//=============================================Duration=========================================================
		$sql33 = "UPDATE duration SET ";
			...
			if ($website == 1)// epike only
		$sql33  .= " durationtrips='0', durationtrips2='1' ";										
			elseif ($website == 2) // centre only
		$sql33  .= " durationtrips='1', durationtrips2='0' ";											
			elseif ($website == 3) // epike and centre
...
//=============================================Operators=========================================================
		$sql333 = "UPDATE operators SET ";
			...
			if ($website == 1)// epike only
		$sql333  .= " operatorstrips='0', operatorstrips2='1' ";										
			elseif ($website == 2) // centre only
		$sql333  .= " operatorstrips='1', operatorstrips=2'0' ";											
			elseif ($website == 3) // epike and centre
...
//=============================================Departuregateways=========================================================
		$sql77 = "UPDATE departuregateways SET ";
			...
			if ($website == 1)// epike only
		$sql77  .= " departuregatewaystrips='0', departuregatewaystrips2='1' ";										
			elseif ($website == 2) // centre only
		$sql77  .= " departuregatewaystrips='1', departuregatewaystrips2='0' ";											
			elseif ($website == 3) // epike and centre
...
//=============================================Activate Trip======================================================
	...
	$sql = "UPDATE trips SET tunique_id='$tunique_id', active='1' WHERE tid=$tid LIMIT 1";
		if (mysqli_query($conn, $sql)) {
		echo "<h4>Success trips active</h4>";
		//	header('Location: ../trips-edit1.php?results=success');
		} else {
			echo "Error updating record: " . mysqli_error($conn);
		//	header('Location: ../trips-edit1.php?results=error');
		}
