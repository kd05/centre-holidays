 ...
 *      ------------
 *
 *      IT SEEMS LIKE EVEN THOUGH THE FILE NAME IS 'export-terminated.php' BUT IT EXPORTS 'SUSPENDED' USERS & NOT 'TERMINATED'
 *
 *      (IF EVER NEED TO WORK ON THIS FILE JUST DOUBLE CHECK, AS WE HAVEN'T LOOK DEEP INTO THE CODE BUT THE EXPORTED USERS
 *      SEEMS 'SUSPENDED')
 *
 **********************************************************************************************************************************/
