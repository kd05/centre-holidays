            ...
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                ...
                <div class="app-content  flex-column-fluid ">
                    ...
                    <div class="app-container  container-xxl ">
                        ...
                        <h3>Suppliers Filter</h3>
                        <div class="card">

                            <!--begin::Card body-->
                            <div class="card-body py-4">

                                <form action="supplier/add-filter.php" method="post" enctype="multipart/form-data" style="background:#FFF; text-align:center; padding:10px">
                                    <input type="text" value="" id="affilter" name="affilter" placeholder="Add Supplier filter" class="form-control" />
...
//                $sql = "SELECT * FROM resourcefilter ORDER BY inchFilter ASC";
                $sql = "SELECT * FROM affiliatefilter ORDER BY affilter ASC";
                                            ...
                                            <div class="table-responsive">
                                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_table_resource_filters">
                                                    ...
                                                    while($row = mysqli_fetch_assoc($result)) {
                                                        ?>
                                                        <form action="supplier/set-filter.php" method="post" enctype="multipart/form-data" style="background:#FFF; text-align:center; padding:10px">
                                                            <input type="hidden" value="<?php echo $row['affilterid']; ?>" id="affilterid" name="affilterid" />
                                                            <tr>
                                                                <td>
                                                                    <?php
                                                                    if ($row['affilteractive']=='1')
                                                                ...
                                                                <td>
                                                                    <input type="text" value="<?php echo $row['affilter']; ?>" id="affilter" name="affilter" style="width:100%; min-height:34px" />
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <a href="supplier/delete-filter.php?affilterid=<?php echo $row['affilterid']; ?>&filter=interests" class="btn btn-danger" style="width:100%" >Delete</a>
                                                                </td>
