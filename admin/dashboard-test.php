    ...
    <div class="card-body flex-column flex-centerp-9">
        ...
        <!--begin::Info-->
            ...
            <div class="d-flex flex-stack justify-content-between my-4">
                <!--begin::Section-->
                <a href="ch-agents.php" target="_blank"
        ...
        <!--begin::Item-->
            <div class="d-flex flex-stack justify-content-between my-4">
                <!--begin::Section-->
                <a href="ch-agents-terminated.php"
                                                        ...
                                                        <?php while($row = mysqli_fetch_assoc($result)) {
                                                            ...
                                                            ?>
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td class="text-end">
                                                                        <a href="unblock.php?blip=<?php echo $row['blip'] ?>" class="btn btn-sm fw-bold btn-warning" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Unblock IP</a>
                                                                    </td>
                                                                </tr>
                                                        <?php } ?>
