...
<a href="export.php" class="btn btn-primary"> <span>List of active Agents (Excel)</span> </a>
<br /><br />
...
//===============================list trips==================================
		...
		$sql = "SELECT * FROM ch_agents_1 WHERE (active=1 || (active=0 AND CloseDate ='')) ORDER BY ".$ord." ASC LIMIT $offset, 500";
