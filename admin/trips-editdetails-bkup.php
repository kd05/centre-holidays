...
<!--<tr>
<th>Details</th>
<td><textarea name="tdetails" id="tdetails" class='scrollable form-control' placeholder="Details"><?php echo $row['tdetails']; ?></textarea></td>
</tr><tr>-->
<th>Prices</th>
...
<div class="dropdown">
    <button class="btn btn-primary dropdown-toggle"  style="width:100%; padding:10px; text-align:left" type="button" data-toggle="dropdown">Types 
    <span class="caret"></span></button>
    <ul class="dropdown-menu" style="width:100%; padding:10px">
...
<?php
	$sql311xsry = "SELECT * FROM servicelevel ORDER BY servicelevel ASC";	  
	...
	if (mysqli_num_rows($result311xsry) > 0) {
		...
		while($row311xsry = mysqli_fetch_assoc($result311xsry)) {
			...
			if (strpos($row['servicelevel'], $row311xsry['servicelevel']) !== false) {
	...
	?>
    <input type="radio" <?php echo $stylecheck66xsry ?> name="servicelevel[]" value="<?php echo $row311xsry['servicelevel']; ?>" />&nbsp;<?php echo $row311xsry['servicelevel']; ?>
    <br />
	<?php
...
<tr>
<th>Highlights (Visiting)</th>

<td><textarea name="thlights" id="thlights" class='scrollable form-control' placeholder="Trip t (please copy past)"><?php echo $row['thlights']; ?></textarea></td>
</tr>
...
<?php
	...
	$sql355 = "SELECT * FROM operators WHERE operators !='".$row['toperators']."' ORDER BY operators ASC";	  
	...
	?>
    <li><input type="checkbox" <?php echo $stylecheck355 ?> name="toperators[]" value="<?php echo $row355['operators']; ?>" />&nbsp;<?php echo $row355['operators']; ?> </li>
    <?php
