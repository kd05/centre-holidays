...
<section>
                  <div class="sttabs tabs-style-bar">
                    <nav>
                      <ul>
                        <li><a href="#section-bar-1" class="sticon ti-user"><span>New Promo </span></a></li>
                      </ul>
                    </nav>
...
$sql = "INSERT INTO promos (promiid, promoactive) VALUES ('', '0')";
if (mysqli_query($conn, $sql)) {
	header('Location: promos.php?results=success');
?>
<h4>Success, a new Promo recored opened, to complete the details</h4>
<a href="promos-edit.php" class="btn btn-lg btn-primary" title="Edit Details">Click Here</a>
<?php
} else {
echo "Error opening a new record: " . mysqli_error($conn);
	header('Location: promos.php?results=error');
}
