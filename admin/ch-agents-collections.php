  ...
  <div id="page-wrapper">
	...
	<h3>Add a Portal Collection</h3>
	<table style="margin-top:10px">
	<form action="ch_agents_collections/add-collections.php" method="post" enctype="multipart/form-data">
	<tr>
    <th>Title</th>
    ...
    <tr>   
    <th>Portal Tags (ie. Vacations, Tours) </th>
...
/*    $sql223 = "SELECT * FROM ch_agents_collections_subcategories ORDER BY category ASC";	  
	...
	$sql = "SELECT * FROM ch_agents_collections WHERE collhome=1 ORDER BY coltimestamp DESC LIMIT $offset, 8";
	...
	$Tsql = "SELECT * FROM ch_agents_collections WHERE collhome=1 ORDER BY coltimestamp DESC";
	...
	<form action="ch_agents_collections/update-collections.php" method="post" enctype="multipart/form-data">
	<input type="hidden" value="<?php echo $row['collid']; ?>" name="collid" id="collid" />
	<div class="col-sm-6 col-md-3 col-lg-3">
	<div class="white-box pro-box p-0"><!--https://www.centreholidaysagents.com/collections/img/-->
	<div class="pro-list-img" style="background: url('https://www.centreholidaysagents.com/img/<?php echo $row['collimage']; ?>') center center / cover no-repeat;"></div>
	<br />
    ...
    <div class="panel-body p-t-0">
    <input type="text" id="colTags" name="colTags" value="<?php echo $row['colTags']; ?>" placeholder="Tags" class="form-control" />
    </div>
    <div class="panel-body p-t-0">
...
*/
    ...
    <?php
/*    $sql22 = "SELECT * FROM ch_agents_collections_subcategories ORDER BY subcategory ASC, category ASC";	  
    $result22 = mysqli_query($conn, $sql22);	
    while($row22 = mysqli_fetch_assoc($result22)) {*/

    ?>
    <option value="<?php //echo $row22['subcategory']?>"><?php //echo $row22['subcategory'].'-'.$row22['category'] ?></option>
    <?php
        //}
    ?>
	...
	?>
	<td>
	<a href='ch_agents_collections/deactivate-collections.php?collid=<?php echo $row['collid']; ?>' class='btn btn-warning' title='Click her to Deactivate'>Deactivate</a>
	</td>
	<?php
	}
	elseif ($active==0)
	...
	?>
	<td>
	<a href="ch_agents_collections/activate-collections.php?collid=<?php echo $row['collid']; ?>" class="btn btn-success" title="Click here to Activate">Activate</a>
	</td>
	<?php
	}
	?>
	<td>
	<a href="ch_agents_collections/delete-collections.php?collid=<?php echo $row['collid']; ?>" class="btn btn-danger" title="Delete" onclick="return confirm_delete()">Del</a>
	</td>                            
	</tr>
    <tr><td colspan="3"><a href="ch_agents_collections/homepage-remove-collections.php?collid=<?php echo $row['collid']; ?>" class="btn btn-default" title="Remove" onclick="return confirm_delete()" style="width:100%; background:#900; color:#FFF">Remove from Home Page</a></td></tr>
    <tr><td colspan="3"><a href="ch_agents_collections/duplicate-collections.php?collid=<?php echo $row['collid']; ?>" class="btn btn-default" title="Remove" onclick="return confirm_delete()" style="width:100%; background:#808000; color:#FFF">Duplicate this Colletion</a></td></tr>    
    </table>                           
	...
	$sql1 = "SELECT * FROM ch_agents_collections WHERE collhome !=1 ORDER BY coltimestamp DESC LIMIT $offset1, 8";
	...
	$Tsql1 = "SELECT * FROM ch_agents_collections WHERE collhome !=1 ORDER BY coltimestamp DESC";
...
/*    $sql22 = "SELECT * FROM ch_agents_collections_subcategories ORDER BY subcategory ASC, category ASC";	  
    ...
    <tr><td colspan="3"><a href="ch_agents_collections/homepage-add-collections.php?collid=<?php echo $row['collid']; ?>" class="btn btn-info" title="Delete" onclick="return confirm_delete()" style="width:100%">Display in Home Page</a></td></tr>
    </table>                           
