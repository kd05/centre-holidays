    ...
    <div class="card-body flex-column flex-centerp-9">
        ...
        <!--begin::Info-->
            ...
            <div class="d-flex flex-stack justify-content-between my-4">
                <!--begin::Section-->
                <a href="https://centreholidays.com/work-from-home/home-based-travel-agent-canada.php#pricing" title="See Plans & Pricing" target="_blank" class="text-warning fw-semibold fs-6 me-2">Active (200)</a>                   
                <!--end::Section--> 
        ...
        <!--begin::Item-->
            <div class="d-flex flex-stack justify-content-between my-4">
                <!--begin::Section-->
                <a href="https://pay.google.com/gp/w/u/0/home/accountdetail?ebaid=AJ9oCCzZWCO1hSqlPFzCJGZDVttJdPXZ6G2lowLqk5pcQoxbY11KI8%2FDkIAtgGfMpVrrsJvD8f0Y" title="Access Google Ads Billing" target="_blank" class="text-warning fw-semibold fs-6 me-2">Suspended (1)</a>                   
                <!--end::Section--> 
        ...
        <!--begin::Item-->
            <div class="d-flex flex-stack justify-content-between my-4">
                <!--begin::Section-->
                <a href="https://pay.google.com/gp/w/u/0/home/accountdetail?ebaid=AJ9oCCzZWCO1hSqlPFzCJGZDVttJdPXZ6G2lowLqk5pcQoxbY11KI8%2FDkIAtgGfMpVrrsJvD8f0Y" title="Access Google Ads Billing" target="_blank" class="text-warning fw-semibold fs-6 me-2">Terminated (100)</a>                   
                <!--end::Section--> 
...
<div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive"><table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table">
    ...
    <tbody class="fw-semibold text-gray-600">
            ...
            <tr class="odd">
                <td data-order="2020-12-14T20:43:00-05:00"> 192.168.1.1 </td>
                <td><a href="/metronic8/demo1/../demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">457</a></td>
                <td>
                  <a href="/metronic8/demo1/../demo1/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Andre Montaut</a>
                </td>
                <td data-order="2020-12-14T20:43:00-05:00"> andre@centreholidays.com </td>
                <td data-order="2020-12-14T20:43:00-05:00">
                  01/01/2024 at 10:14:46 pm                </td>
                <td class="text-end">
                    <a href="#" class="btn btn-sm fw-bold btn-warning" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">
            Unblock IP</a>
                </td>
            </tr></tbody>
</table></div><div class="row"><div class="col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end"><div class="dataTables_paginate paging_simple_numbers" id="kt_customers_table_paginate"><ul class="pagination"><li class="paginate_button page-item previous disabled" id="kt_customers_table_previous"><a href="#" aria-controls="kt_customers_table" data-dt-idx="0" tabindex="0" class="page-link"><i class="previous"></i></a></li><li class="paginate_button page-item active"><a href="#" aria-controls="kt_customers_table" data-dt-idx="1" tabindex="0" class="page-link">1</a></li><li class="paginate_button page-item "><a href="#" aria-controls="kt_customers_table" data-dt-idx="2" tabindex="0" class="page-link">2</a></li><li class="paginate_button page-item "><a href="#" aria-controls="kt_customers_table" data-dt-idx="3" tabindex="0" class="page-link">3</a></li><li class="paginate_button page-item "><a href="#" aria-controls="kt_customers_table" data-dt-idx="4" tabindex="0" class="page-link">4</a></li><li class="paginate_button page-item next" id="kt_customers_table_next"><a href="#" aria-controls="kt_customers_table" data-dt-idx="5" tabindex="0" class="page-link"><i class="next"></i></a></li></ul></div></div></div></div>
<!--end::Table-->    </div>
    <!--end::Card body-->
</div>
</div>
