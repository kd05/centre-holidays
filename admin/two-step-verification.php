...
<title>2-Step Verification | CH Admin Portal</title>
...
<form class="form w-100" action="https://centreholidays.com/admin/email/verify.php" method="post" enctype="multipart/form-data">

<!--begin::Heading-->
<div class="text-center mb-10">
<!--begin::Title-->
<h1 class="text-dark fw-bolder mb-3">Admin Portal Verification</h1>
<!--end::Title-->
<!--begin::Link-->
