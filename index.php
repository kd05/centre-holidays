...
<title><?php echo $IndexPageTitle.' | '.$TagTitle ?></title>
<meta name="description" content="<?php echo $NewIndexMetaDescription ?>">
<!-- begin:: Facebook Sharing -->
<meta property="og:image" content="<?php echo $FacebookImage; ?>" />
<meta property="og:description" content="<?php echo $NewIndexMetaDescription ?>">
...
<!--begin::Carousel-->
<div id="index-carousel" class="carousel slide carousel-fade" data-interval="10000" data-ride="carousel">
<div class="carousel-inner">
<div class="carousel-item active">
<div class="img"><img class="d-block w-100" src="<?php echo $NewIndexCoverImage ?>" alt="<?php echo $IndexImageDescription ?>"></div>
<div class="carousel-caption d-none d-md-block">
<a href="#">
<button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase"><?php echo $IndexImageDescription ?></button></a> 
</div>
</div>
<?php if (!empty($Slider2Image)) { ?>
<div class="carousel-item">
<div class="img"><img class="d-block w-100" src="<?php echo $Slider2Image ?>" alt="<?php echo $Slider2Title ?>"></div>
<div class="carousel-caption d-none d-md-block">
<a href="#">
<button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase"><?php echo $Slider2Title ?></button></a> 
</div>
</div>
<?php } ?>
<?php if (!empty($Slider3Image)) { ?>
<div class="carousel-item">
<div class="img"><img class="d-block w-100" src="<?php echo $Slider3Image ?>" alt="<?php echo $Slider3Title ?>"></div>
<div class="carousel-caption d-none d-md-block">
<a href="#">
<button type="button" class="btn btn-dark btn-square btn-wide font-weight-bolder text-uppercase"><?php echo $Slider3Title ?></button></a> 
</div>
</div>
<?php } ?>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center pl-10 pr-10">
			<div class="text-center pt-11 col-xl-12">
									<h1 class="font-weight-boldest text-uppercase text-dark display-3"><?php echo $NewIndexH1 ?></h1>
									<h2 class="text-dark-65 font-weight-bolder"><?php echo $NewIndexMetaDescription ?></h2>				
            </div>
                                    </div>
          <!--end::title-->
          </div>
